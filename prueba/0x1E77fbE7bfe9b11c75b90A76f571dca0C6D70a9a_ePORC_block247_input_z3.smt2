...
(assert (=> (= t_0 7) (and u_0_0 u_1_0 (or (and (= x_0_0 |s(0)|) (= x_1_0 |s(1)|)) (and (= x_0_0 |s(1)|) (= x_1_0 |s(0)|))) u_0_1 (= x_0_1 |s(2)|) (and (and (= u_1_1 u_2_0) (= x_1_1 x_2_0))) (not u_2_1))))
...
(get-value (t_0))
(get-value (a_0))
; Stack: {'PUSH': 0, 'SWAP2': 6, 'SWAP1': 5, 'DUP1': 3, 'DUP2': 4, 'POP': 1, 'NOP': 2}
; Comm: {'EQ_0': 7}
; Non-Comm: {}
; Mem: {}
; L dict: {'EQ_0': 7}
