...
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (or (and (= x_0_4 1461501637330902918203684832716283019655932542975) (= x_1_4 |s(4)|)) (and (= x_0_4 |s(4)|) (= x_1_4 1461501637330902918203684832716283019655932542975))) u_0_5 (= x_0_5 |s(1)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
; Non-commutative constraints
(assert (not (= t_0 10)))
(assert (=> (= t_1 10) (and (and true (and u_0_1 (= x_0_1 10))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (=> (= t_2 10) (and (and true (and u_0_2 (= x_0_2 10))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2))) (and true) (and true))))
(assert (not (= t_3 10)))
(assert (not (= t_4 10)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 10)) (and (= t_1 0) (= a_1 10)) (and (= t_2 0) (= a_2 10)) (and (= t_3 0) (= a_3 10)) (and (= t_4 0) (= a_4 10))))
