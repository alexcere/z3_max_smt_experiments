...
(assert (=> (= t_3 7) (and (and true) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3))) (and true) (and true (not u_2_3)))))
(assert (=> (= t_4 7) (and (and true) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_0_4) (= x_1_5 x_0_4)) (and (= u_2_5 u_1_4) (= x_2_5 x_1_4))) (and true) (and true (not u_2_4)))))
(assert (not (= t_5 7)))
(assert (not (= t_0 8)))
(assert (=> (= t_1 8) (and (and true (and u_0_1 (= x_0_1 7))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1))) (and true) (and true))))
(assert (=> (= t_2 8) (and (and true (and u_0_2 (= x_0_2 7))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2))) (and true) (and true))))
(assert (=> (= t_3 8) (and (and true (and u_0_3 (= x_0_3 7))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3))) (and true) (and true))))
(assert (=> (= t_4 8) (and (and true (and u_0_4 (= x_0_4 7))) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4))) (and true) (and true))))
(assert (=> (= t_5 8) (and (and true (and u_0_5 (= x_0_5 7))) u_0_6 (= x_0_6 |s(2)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5))) (and true) (and true))))
; Store constraints
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (and (= x_0_1 6) (= x_1_1 |s(0)|)) (and (and (= u_0_2 u_2_1) (= x_0_2 x_2_1))) (not u_2_2) (not u_1_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (and (= x_0_2 6) (= x_1_2 |s(0)|)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2))) (not u_2_3) (not u_1_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (and (= x_0_3 6) (= x_1_3 |s(0)|)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (and (= x_0_4 6) (= x_1_4 |s(0)|)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
(assert (=> (= t_5 9) (and u_0_5 u_1_5 (and (= x_0_5 6) (= x_1_5 |s(0)|)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5))) (not u_2_6) (not u_1_6))))
