...
(assert (and (<= 0 t_3) (< t_3 8)))
(assert (and (<= 0 t_4) (< t_4 8)))
(assert (and (<= 0 t_5) (< t_5 8)))
; Stack contraints
(assert (=> (= t_0 2) (= t_1 2)))
(assert (=> (= t_1 2) (= t_2 2)))
(assert (=> (= t_2 2) (= t_3 2)))
...
(assert (not (= t_0 6)))
(assert (not (= t_1 6)))
(assert (=> (= t_2 6) (and (and true (and u_0_2 (= x_0_2 |s(2)|)) (and u_1_2 (= x_1_2 4))) u_0_3 (= x_0_3 |s(1)|) true (and true (not u_1_3)) (and true))))
(assert (=> (= t_3 6) (and (and true (and u_0_3 (= x_0_3 |s(2)|)) (and u_1_3 (= x_1_3 4))) u_0_4 (= x_0_4 |s(1)|) true (and true (not u_1_4)) (and true))))
(assert (=> (= t_4 6) (and (and true (and u_0_4 (= x_0_4 |s(2)|)) (and u_1_4 (= x_1_4 4))) u_0_5 (= x_0_5 |s(1)|) true (and true (not u_1_5)) (and true))))
(assert (=> (= t_5 6) (and (and true (and u_0_5 (= x_0_5 |s(2)|)) (and u_1_5 (= x_1_5 4))) u_0_6 (= x_0_6 |s(1)|) true (and true (not u_1_6)) (and true))))
; Store constraints
(assert (not (= t_0 7)))
(assert (not (= t_1 7)))
...
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 4) (= t_0 7))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 4) (= t_1 7))))
(assert (=> (= t_3 1) (or (= t_2 1) (= t_2 4) (= t_2 7))))
(assert (=> (= t_4 1) (or (= t_3 1) (= t_3 4) (= t_3 7))))
(assert (=> (= t_5 1) (or (= t_4 1) (= t_4 4) (= t_4 7))))
; All uninterpreted functions in the final stack are eventually used
(assert (or (= t_0 5) (= t_1 5) (= t_2 5) (= t_3 5) (= t_4 5)))
; Constraints using l variables
(assert (and (<= 2 l_7) (< l_7 6)))
(assert (= (= t_2 7) (= l_7 2)))
(assert (= (= t_3 7) (= l_7 3)))
(assert (= (= t_4 7) (= l_7 4)))
(assert (= (= t_5 7) (= l_7 5)))
...
; Comm: {}
; Non-Comm: {'CALLDATASIZE_0': 5, 'LT_0': 6}
; Mem: {'MSTORE_0': 7}
; L dict: {'MSTORE_0': 7, 'LT_0': 6}
