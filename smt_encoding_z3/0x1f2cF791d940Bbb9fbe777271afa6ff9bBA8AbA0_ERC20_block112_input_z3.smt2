...
(assert (=> (= t_0 11) (and u_0_0 u_1_0 (or (and (= x_0_0 |s(1)|) (= x_1_0 |s(2)|)) (and (= x_0_0 |s(2)|) (= x_1_0 |s(1)|))) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_2_0) (= x_1_1 x_2_0)) (and (= u_2_1 u_3_0) (= x_2_1 x_3_0)) (and (= u_3_1 u_4_0) (= x_3_1 x_4_0))) (not u_4_1))))
(assert (=> (= t_1 11) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(1)|) (= x_1_1 |s(2)|)) (and (= x_0_1 |s(2)|) (= x_1_1 |s(1)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (not u_4_2))))
(assert (not (= t_2 11)))
