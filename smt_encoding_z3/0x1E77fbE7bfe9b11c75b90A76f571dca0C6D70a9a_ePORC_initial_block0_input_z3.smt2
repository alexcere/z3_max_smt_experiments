...
(assert (=> (= t_0 8) (and (and true) u_0_1 (= x_0_1 |s(3)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0))) (and true) (and true (not u_2_0)))))
(assert (=> (= t_1 8) (and (and true) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1))) (and true) (and true (not u_2_1)))))
(assert (=> (= t_2 8) (and (and true) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2))) (and true) (and true (not u_2_2)))))
(assert (=> (= t_3 8) (and (and true) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3))) (and true) (and true (not u_2_3)))))
(assert (=> (= t_4 8) (and (and true) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_0_4) (= x_1_5 x_0_4)) (and (= u_2_5 u_1_4) (= x_2_5 x_1_4))) (and true) (and true (not u_2_4)))))
(assert (=> (= t_5 8) (and (and true) u_0_6 (= x_0_6 |s(3)|) (and (and (= u_1_6 u_0_5) (= x_1_6 x_0_5)) (and (= u_2_6 u_1_5) (= x_2_6 x_1_5))) (and true) (and true (not u_2_5)))))
(assert (not (= t_6 8)))
; Store constraints
(assert (not (= t_0 7)))
(assert (not (= t_1 7)))
(assert (=> (= t_2 7) (and u_0_2 u_1_2 (and (= x_0_2 64) (= x_1_2 128)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2))) (not u_2_3) (not u_1_3))))
(assert (=> (= t_3 7) (and u_0_3 u_1_3 (and (= x_0_3 64) (= x_1_3 128)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 7) (and u_0_4 u_1_4 (and (= x_0_4 64) (= x_1_4 128)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
(assert (=> (= t_5 7) (and u_0_5 u_1_5 (and (= x_0_5 64) (= x_1_5 128)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5))) (not u_2_6) (not u_1_6))))
(assert (=> (= t_6 7) (and u_0_6 u_1_6 (and (= x_0_6 64) (= x_1_6 128)) (and (and (= u_0_7 u_2_6) (= x_0_7 x_2_6))) (not u_2_7) (not u_1_7))))
; Initial stack constraints
(assert (not u_0_0))
(assert (not u_1_0))
(assert (not u_2_0))
; Final stack constraints
(assert (and u_0_7 (= x_0_7 115792089237316195423570985008687907853269984665640564039457584007913129639935)))
(assert (and u_1_7 (= x_1_7 1000000000000000)))
...
(assert (or (and (= t_0 0) (= a_0 128)) (and (= t_1 0) (= a_1 128)) (and (= t_2 0) (= a_2 128)) (and (= t_3 0) (= a_3 128)) (and (= t_4 0) (= a_4 128)) (and (= t_5 0) (= a_5 128)) (and (= t_6 0) (= a_6 128))))
...
(assert (or (and (= t_0 0) (= a_0 1000000000000000)) (and (= t_1 0) (= a_1 1000000000000000)) (and (= t_2 0) (= a_2 1000000000000000)) (and (= t_3 0) (= a_3 1000000000000000)) (and (= t_4 0) (= a_4 1000000000000000)) (and (= t_5 0) (= a_5 1000000000000000)) (and (= t_6 0) (= a_6 1000000000000000))))
; If we push or dup a value, the following instruction cannot be a pop
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 5) (= t_0 6) (= t_0 7))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 5) (= t_1 6) (= t_1 7))))
(assert (=> (= t_3 1) (or (= t_2 1) (= t_2 5) (= t_2 6) (= t_2 7))))
(assert (=> (= t_4 1) (or (= t_3 1) (= t_3 5) (= t_3 6) (= t_3 7))))
(assert (=> (= t_5 1) (or (= t_4 1) (= t_4 5) (= t_4 6) (= t_4 7))))
(assert (=> (= t_6 1) (or (= t_5 1) (= t_5 5) (= t_5 6) (= t_5 7))))
; All uninterpreted functions in the final stack are eventually used
(assert (or (= t_0 8) (= t_1 8) (= t_2 8) (= t_3 8) (= t_4 8) (= t_5 8)))
; Constraints using l variables
(assert (and (<= 2 l_7) (< l_7 7)))
(assert (= (= t_2 7) (= l_7 2)))
(assert (= (= t_3 7) (= l_7 3)))
(assert (= (= t_4 7) (= l_7 4)))
(assert (= (= t_5 7) (= l_7 5)))
