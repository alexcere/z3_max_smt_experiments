...
(assert (not (= t_3 8)))
(assert (not (= t_4 8)))
(assert (=> (= t_5 8) (and (and true (and u_0_5 (= x_0_5 961581905)) (and u_1_5 (= x_1_5 |s(3)|))) u_0_6 (= x_0_6 |s(2)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5))) (and true (not u_2_6)) (and true))))
(assert (=> (= t_6 8) (and (and true (and u_0_6 (= x_0_6 961581905)) (and u_1_6 (= x_1_6 |s(3)|))) u_0_7 (= x_0_7 |s(2)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6))) (and true (not u_2_7)) (and true))))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 961581905)) (and (= t_1 0) (= a_1 961581905)) (and (= t_2 0) (= a_2 961581905)) (and (= t_3 0) (= a_3 961581905)) (and (= t_4 0) (= a_4 961581905)) (and (= t_5 0) (= a_5 961581905)) (and (= t_6 0) (= a_6 961581905))))
