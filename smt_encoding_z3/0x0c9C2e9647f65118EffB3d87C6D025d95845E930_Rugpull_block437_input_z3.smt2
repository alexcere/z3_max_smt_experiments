...
(assert (=> (= t_0 11) (and u_0_0 u_1_0 (or (and (= x_0_0 |s(3)|) (= x_1_0 |s(2)|)) (and (= x_0_0 |s(2)|) (= x_1_0 |s(3)|))) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_2_0) (= x_1_1 x_2_0)) (and (= u_2_1 u_3_0) (= x_2_1 x_3_0)) (and (= u_3_1 u_4_0) (= x_3_1 x_4_0))) (not u_4_1))))
(assert (=> (= t_1 11) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(3)|) (= x_1_1 |s(2)|)) (and (= x_0_1 |s(2)|) (= x_1_1 |s(3)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (not u_4_2))))
(assert (=> (= t_2 11) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(3)|) (= x_1_2 |s(2)|)) (and (= x_0_2 |s(2)|) (= x_1_2 |s(3)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (not u_4_3))))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(3)|) (= x_1_3 |s(2)|)) (and (= x_0_3 |s(2)|) (= x_1_3 |s(3)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(3)|) (= x_1_4 |s(2)|)) (and (= x_0_4 |s(2)|) (= x_1_4 |s(3)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (not (= t_5 11)))
; Non-commutative constraints
; Store constraints
(assert (not (= t_0 12)))
(assert (not (= t_1 12)))
(assert (=> (= t_2 12) (and u_0_2 u_1_2 (and (= x_0_2 |s(4)|) (= x_1_2 0)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2)) (and (= u_1_3 u_3_2) (= x_1_3 x_3_2)) (and (= u_2_3 u_4_2) (= x_2_3 x_4_2))) (not u_4_3) (not u_3_3))))
(assert (=> (= t_3 12) (and u_0_3 u_1_3 (and (= x_0_3 |s(4)|) (= x_1_3 0)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3)) (and (= u_1_4 u_3_3) (= x_1_4 x_3_3)) (and (= u_2_4 u_4_3) (= x_2_4 x_4_3))) (not u_4_4) (not u_3_4))))
(assert (=> (= t_4 12) (and u_0_4 u_1_4 (and (= x_0_4 |s(4)|) (= x_1_4 0)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4)) (and (= u_1_5 u_3_4) (= x_1_5 x_3_4)) (and (= u_2_5 u_4_4) (= x_2_5 x_4_4))) (not u_4_5) (not u_3_5))))
(assert (=> (= t_5 12) (and u_0_5 u_1_5 (and (= x_0_5 |s(4)|) (= x_1_5 0)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5)) (and (= u_1_6 u_3_5) (= x_1_6 x_3_5)) (and (= u_2_6 u_4_5) (= x_2_6 x_4_5))) (not u_4_6) (not u_3_6))))
