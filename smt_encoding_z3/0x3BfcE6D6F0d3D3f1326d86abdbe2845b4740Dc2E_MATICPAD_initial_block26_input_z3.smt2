...
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(1)|) (= x_1_1 127)) (and (= x_0_1 127) (= x_1_1 |s(1)|))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (not u_3_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(1)|) (= x_1_2 127)) (and (= x_0_2 127) (= x_1_2 |s(1)|))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(1)|) (= x_1_3 127)) (and (= x_0_3 127) (= x_1_3 |s(1)|))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (not u_3_4))))
(assert (not (= t_4 9)))
...
(assert (and u_1_5 (= x_1_5 |s(2)|)))
(assert (not u_2_5))
(assert (not u_3_5))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 127)) (and (= t_1 0) (= a_1 127)) (and (= t_2 0) (= a_2 127)) (and (= t_3 0) (= a_3 127)) (and (= t_4 0) (= a_4 127))))
