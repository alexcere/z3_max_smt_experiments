...
(assert (not (= t_0 8)))
(assert (not (= t_1 8)))
(assert (=> (= t_2 8) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(2)|) (= x_1_2 |s(3)|)) (and (= x_0_2 |s(3)|) (= x_1_2 |s(2)|))) u_0_3 (= x_0_3 |s(1)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (not u_2_3))))
(assert (=> (= t_3 8) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(2)|) (= x_1_3 |s(3)|)) (and (= x_0_3 |s(3)|) (= x_1_3 |s(2)|))) u_0_4 (= x_0_4 |s(1)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3))) (not u_2_4))))
(assert (=> (= t_4 8) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(2)|) (= x_1_4 |s(3)|)) (and (= x_0_4 |s(3)|) (= x_1_4 |s(2)|))) u_0_5 (= x_0_5 |s(1)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4))) (not u_2_5))))
(assert (=> (= t_5 8) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(2)|) (= x_1_5 |s(3)|)) (and (= x_0_5 |s(3)|) (= x_1_5 |s(2)|))) u_0_6 (= x_0_6 |s(1)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5))) (not u_2_6))))
; Non-commutative constraints
(assert (=> (= t_0 10) (and (and true) u_0_1 (= x_0_1 |s(3)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0))) (and true) (and true (not u_2_0)))))
(assert (=> (= t_1 10) (and (and true) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1))) (and true) (and true (not u_2_1)))))
(assert (=> (= t_2 10) (and (and true) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2))) (and true) (and true (not u_2_2)))))
(assert (=> (= t_3 10) (and (and true) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3))) (and true) (and true (not u_2_3)))))
(assert (not (= t_4 10)))
(assert (not (= t_5 10)))
...
(assert (=> (= t_1 7) (and (and true) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1))) (and true) (and true (not u_2_1)))))
(assert (=> (= t_2 7) (and (and true) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2))) (and true) (and true (not u_2_2)))))
(assert (=> (= t_3 7) (and (and true) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3))) (and true) (and true (not u_2_3)))))
(assert (=> (= t_4 7) (and (and true) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_0_4) (= x_1_5 x_0_4)) (and (= u_2_5 u_1_4) (= x_2_5 x_1_4))) (and true) (and true (not u_2_4)))))
(assert (not (= t_5 7)))
; Store constraints
(assert (not (= t_0 9)))
(assert (not (= t_1 9)))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (and (= x_0_2 64) (= x_1_2 128)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2))) (not u_2_3) (not u_1_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (and (= x_0_3 64) (= x_1_3 128)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (and (= x_0_4 64) (= x_1_4 128)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
(assert (=> (= t_5 9) (and u_0_5 u_1_5 (and (= x_0_5 64) (= x_1_5 128)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5))) (not u_2_6) (not u_1_6))))
; Initial stack constraints
(assert (not u_0_0))
(assert (not u_1_0))
(assert (not u_2_0))
; Final stack constraints
(assert (and u_0_6 (= x_0_6 |s(1)|)))
(assert (not u_1_6))
(assert (not u_2_6))
...
(assert (or (and (= t_0 0) (= a_0 128)) (and (= t_1 0) (= a_1 128)) (and (= t_2 0) (= a_2 128)) (and (= t_3 0) (= a_3 128)) (and (= t_4 0) (= a_4 128)) (and (= t_5 0) (= a_5 128))))
...
(assert (or (= t_0 10) (= t_1 10) (= t_2 10) (= t_3 10)))
(assert (or (= t_0 7) (= t_1 7) (= t_2 7) (= t_3 7) (= t_4 7)))
; Constraints using l variables
(assert (and (<= 2 l_9) (< l_9 6)))
(assert (= (= t_2 9) (= l_9 2)))
(assert (= (= t_3 9) (= l_9 3)))
(assert (= (= t_4 9) (= l_9 4)))
(assert (= (= t_5 9) (= l_9 5)))
(assert (and (<= 2 l_8) (< l_8 6)))
(assert (= (= t_2 8) (= l_8 2)))
(assert (= (= t_3 8) (= l_8 3)))
(assert (= (= t_4 8) (= l_8 4)))
(assert (= (= t_5 8) (= l_8 5)))
...
; Comm: {'EQ_0': 8}
; Non-Comm: {'ADDRESS_0': 7, 'PUSHDEPLOYADDRESS_0': 10}
; Mem: {'MSTORE_0': 9}
; L dict: {'MSTORE_0': 9, 'EQ_0': 8}
