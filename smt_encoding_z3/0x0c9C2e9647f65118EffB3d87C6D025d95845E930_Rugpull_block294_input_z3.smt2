...
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(0)|) (= x_1_1 1461501637330902918203684832716283019655932542975)) (and (= x_0_1 1461501637330902918203684832716283019655932542975) (= x_1_1 |s(0)|))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (not u_3_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(0)|) (= x_1_2 1461501637330902918203684832716283019655932542975)) (and (= x_0_2 1461501637330902918203684832716283019655932542975) (= x_1_2 |s(0)|))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
