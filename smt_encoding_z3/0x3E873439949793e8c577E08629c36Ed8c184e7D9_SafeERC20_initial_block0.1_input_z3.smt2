...
(assert (not (= t_2 10)))
(assert (not (= t_3 10)))
(assert (=> (= t_4 10) (and u_0_4 u_1_4 (or (and (= x_0_4 115) (= x_1_4 |s(5)|)) (and (= x_0_4 |s(5)|) (= x_1_4 115))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
(assert (=> (= t_5 10) (and u_0_5 u_1_5 (or (and (= x_0_5 115) (= x_1_5 |s(5)|)) (and (= x_0_5 |s(5)|) (= x_1_5 115))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5))) (not u_3_6))))
; Non-commutative constraints
(assert (=> (= t_0 11) (and (and true (and u_0_0 (= x_0_0 |s(0)|))) u_0_1 (= x_0_1 |s(6)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0)) (and (= u_2_1 u_2_0) (= x_2_1 x_2_0)) (and (= u_3_1 u_3_0) (= x_3_1 x_3_0))) (and true) (and true))))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(0)|))) u_0_2 (= x_0_2 |s(6)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (not (= t_2 11)))
(assert (not (= t_3 11)))
(assert (not (= t_4 11)))
(assert (not (= t_5 11)))
(assert (not (= t_0 9)))
(assert (not (= t_1 9)))
(assert (=> (= t_2 9) (and (and true (and u_0_2 (= x_0_2 0)) (and u_1_2 (= x_1_2 |s(6)|))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (and true (not u_3_3)) (and true))))
(assert (=> (= t_3 9) (and (and true (and u_0_3 (= x_0_3 0)) (and u_1_3 (= x_1_3 |s(6)|))) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (and true (not u_3_4)) (and true))))
(assert (not (= t_4 9)))
(assert (not (= t_5 9)))
; Store constraints
...
(assert (and (<= 0 l_11) (< l_11 2)))
(assert (= (= t_0 11) (= l_11 0)))
(assert (= (= t_1 11) (= l_11 1)))
(assert (and (<= 2 l_9) (< l_9 4)))
(assert (= (= t_2 9) (= l_9 2)))
(assert (= (= t_3 9) (= l_9 3)))
...
; Comm: {'EQ_0': 10}
; Non-Comm: {'BYTE_0': 9, 'MLOAD_0': 11}
; Mem: {}
; L dict: {'MLOAD_0': 11, 'BYTE_0': 9, 'EQ_0': 10}
