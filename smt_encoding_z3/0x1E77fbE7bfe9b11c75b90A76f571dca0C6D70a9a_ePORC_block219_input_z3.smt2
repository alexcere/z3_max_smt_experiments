...
(assert (not (= t_1 9)))
(assert (not (= t_2 9)))
(assert (=> (= t_3 9) (and (and true (and u_0_3 (= x_0_3 |s(2)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3))) (and true) (and true))))
(assert (=> (= t_4 9) (and (and true (and u_0_4 (= x_0_4 |s(2)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4))) (and true) (and true))))
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 5))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (not (= t_2 11)))
(assert (not (= t_3 11)))
(assert (not (= t_4 11)))
(assert (not (= t_0 10)))
(assert (not (= t_1 10)))
(assert (=> (= t_2 10) (and (and true (and u_0_2 (= x_0_2 |s(0)|)) (and u_1_2 (= x_1_2 |s(3)|))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (and true (not u_3_3)) (and true))))
(assert (=> (= t_3 10) (and (and true (and u_0_3 (= x_0_3 |s(0)|)) (and u_1_3 (= x_1_3 |s(3)|))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (and true (not u_3_4)) (and true))))
(assert (not (= t_4 10)))
; Store constraints
...
(assert (and (<= 3 l_9) (< l_9 5)))
(assert (= (= t_3 9) (= l_9 3)))
(assert (= (= t_4 9) (= l_9 4)))
(assert (and (<= 1 l_11) (< l_11 2)))
(assert (= (= t_1 11) (= l_11 1)))
(assert (and (<= 2 l_10) (< l_10 4)))
...
; Comm: {}
; Non-Comm: {'ISZERO_0': 9, 'LT_0': 10, 'SLOAD_0': 11}
; Mem: {}
; L dict: {'ISZERO_0': 9, 'SLOAD_0': 11, 'LT_0': 10}
