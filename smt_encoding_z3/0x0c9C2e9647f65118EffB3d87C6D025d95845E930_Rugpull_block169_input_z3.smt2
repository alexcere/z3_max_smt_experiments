...
(assert (=> (= t_0 5) (and (and true (and u_0_0 (= x_0_0 |s(0)|))) u_0_1 (= x_0_1 |s(2)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0))) (and true) (and true))))
(assert (=> (= t_1 5) (and (and true (and u_0_1 (= x_0_1 |s(0)|))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1))) (and true) (and true))))
; Store constraints
; Initial stack constraints
(assert (and u_0_0 (= x_0_0 |s(0)|)))
(assert (not u_1_0))
; Final stack constraints
(assert (and u_0_2 (= x_0_2 |s(2)|)))
