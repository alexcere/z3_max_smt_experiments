...
(assert (=> (= t_0 11) (and (and true) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0)) (and (= u_3_1 u_2_0) (= x_3_1 x_2_0)) (and (= u_4_1 u_3_0) (= x_4_1 x_3_0))) (and true) (and true (not u_4_0)))))
(assert (=> (= t_1 11) (and (and true) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1)) (and (= u_3_2 u_2_1) (= x_3_2 x_2_1)) (and (= u_4_2 u_3_1) (= x_4_2 x_3_1))) (and true) (and true (not u_4_1)))))
(assert (=> (= t_2 11) (and (and true) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2)) (and (= u_3_3 u_2_2) (= x_3_3 x_2_2)) (and (= u_4_3 u_3_2) (= x_4_3 x_3_2))) (and true) (and true (not u_4_2)))))
(assert (=> (= t_3 11) (and (and true) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3)) (and (= u_3_4 u_2_3) (= x_3_4 x_2_3)) (and (= u_4_4 u_3_3) (= x_4_4 x_3_3))) (and true) (and true (not u_4_3)))))
(assert (not (= t_4 11)))
; Store constraints
...
(assert (or (= t_0 11) (= t_1 11) (= t_2 11) (= t_3 11)))
