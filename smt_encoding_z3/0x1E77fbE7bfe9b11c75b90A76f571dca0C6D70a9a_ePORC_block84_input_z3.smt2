...
(assert (=> (= t_0 11) (and u_0_0 u_1_0 (or (and (= x_0_0 |s(2)|) (= x_1_0 |s(0)|)) (and (= x_0_0 |s(0)|) (= x_1_0 |s(2)|))) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_2_0) (= x_1_1 x_2_0)) (and (= u_2_1 u_3_0) (= x_2_1 x_3_0)) (and (= u_3_1 u_4_0) (= x_3_1 x_4_0))) (not u_4_1))))
(assert (=> (= t_1 11) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(2)|) (= x_1_1 |s(0)|)) (and (= x_0_1 |s(0)|) (= x_1_1 |s(2)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (not u_4_2))))
(assert (=> (= t_2 11) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(2)|) (= x_1_2 |s(0)|)) (and (= x_0_2 |s(0)|) (= x_1_2 |s(2)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (not u_4_3))))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(2)|) (= x_1_3 |s(0)|)) (and (= x_0_3 |s(0)|) (= x_1_3 |s(2)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(2)|) (= x_1_4 |s(0)|)) (and (= x_0_4 |s(0)|) (= x_1_4 |s(2)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (=> (= t_5 11) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(2)|) (= x_1_5 |s(0)|)) (and (= x_0_5 |s(0)|) (= x_1_5 |s(2)|))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (not u_4_6))))
(assert (=> (= t_6 11) (and u_0_6 u_1_6 (or (and (= x_0_6 |s(2)|) (= x_1_6 |s(0)|)) (and (= x_0_6 |s(0)|) (= x_1_6 |s(2)|))) u_0_7 (= x_0_7 |s(4)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (not u_4_7))))
(assert (=> (= t_7 11) (and u_0_7 u_1_7 (or (and (= x_0_7 |s(2)|) (= x_1_7 |s(0)|)) (and (= x_0_7 |s(0)|) (= x_1_7 |s(2)|))) u_0_8 (= x_0_8 |s(4)|) (and (and (= u_1_8 u_2_7) (= x_1_8 x_2_7)) (and (= u_2_8 u_3_7) (= x_2_8 x_3_7)) (and (= u_3_8 u_4_7) (= x_3_8 x_4_7))) (not u_4_8))))
(assert (=> (= t_8 11) (and u_0_8 u_1_8 (or (and (= x_0_8 |s(2)|) (= x_1_8 |s(0)|)) (and (= x_0_8 |s(0)|) (= x_1_8 |s(2)|))) u_0_9 (= x_0_9 |s(4)|) (and (and (= u_1_9 u_2_8) (= x_1_9 x_2_8)) (and (= u_2_9 u_3_8) (= x_2_9 x_3_8)) (and (= u_3_9 u_4_8) (= x_3_9 x_4_8))) (not u_4_9))))
(assert (not (= t_9 11)))
; Non-commutative constraints
(assert (not (= t_0 12)))
(assert (not (= t_1 12)))
(assert (=> (= t_2 12) (and (and true (and u_0_2 (= x_0_2 0)) (and u_1_2 (= x_1_2 32))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (and true (not u_4_3)) (and true))))
(assert (=> (= t_3 12) (and (and true (and u_0_3 (= x_0_3 0)) (and u_1_3 (= x_1_3 32))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (and true (not u_4_4)) (and true))))
(assert (=> (= t_4 12) (and (and true (and u_0_4 (= x_0_4 0)) (and u_1_4 (= x_1_4 32))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (and true (not u_4_5)) (and true))))
(assert (=> (= t_5 12) (and (and true (and u_0_5 (= x_0_5 0)) (and u_1_5 (= x_1_5 32))) u_0_6 (= x_0_6 |s(3)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (and true (not u_4_6)) (and true))))
(assert (=> (= t_6 12) (and (and true (and u_0_6 (= x_0_6 0)) (and u_1_6 (= x_1_6 32))) u_0_7 (= x_0_7 |s(3)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (and true (not u_4_7)) (and true))))
(assert (=> (= t_7 12) (and (and true (and u_0_7 (= x_0_7 0)) (and u_1_7 (= x_1_7 32))) u_0_8 (= x_0_8 |s(3)|) (and (and (= u_1_8 u_2_7) (= x_1_8 x_2_7)) (and (= u_2_8 u_3_7) (= x_2_8 x_3_7)) (and (= u_3_8 u_4_7) (= x_3_8 x_4_7))) (and true (not u_4_8)) (and true))))
(assert (=> (= t_8 12) (and (and true (and u_0_8 (= x_0_8 0)) (and u_1_8 (= x_1_8 32))) u_0_9 (= x_0_9 |s(3)|) (and (and (= u_1_9 u_2_8) (= x_1_9 x_2_8)) (and (= u_2_9 u_3_8) (= x_2_9 x_3_8)) (and (= u_3_9 u_4_8) (= x_3_9 x_4_8))) (and true (not u_4_9)) (and true))))
(assert (not (= t_9 12)))
; Store constraints
(assert (not (= t_0 13)))
(assert (=> (= t_1 13) (and u_0_1 u_1_1 (and (= x_0_1 0) (= x_1_1 |s(1)|)) (and (and (= u_0_2 u_2_1) (= x_0_2 x_2_1)) (and (= u_1_2 u_3_1) (= x_1_2 x_3_1)) (and (= u_2_2 u_4_1) (= x_2_2 x_4_1))) (not u_4_2) (not u_3_2))))
(assert (=> (= t_2 13) (and u_0_2 u_1_2 (and (= x_0_2 0) (= x_1_2 |s(1)|)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2)) (and (= u_1_3 u_3_2) (= x_1_3 x_3_2)) (and (= u_2_3 u_4_2) (= x_2_3 x_4_2))) (not u_4_3) (not u_3_3))))
(assert (=> (= t_3 13) (and u_0_3 u_1_3 (and (= x_0_3 0) (= x_1_3 |s(1)|)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3)) (and (= u_1_4 u_3_3) (= x_1_4 x_3_3)) (and (= u_2_4 u_4_3) (= x_2_4 x_4_3))) (not u_4_4) (not u_3_4))))
(assert (=> (= t_4 13) (and u_0_4 u_1_4 (and (= x_0_4 0) (= x_1_4 |s(1)|)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4)) (and (= u_1_5 u_3_4) (= x_1_5 x_3_4)) (and (= u_2_5 u_4_4) (= x_2_5 x_4_4))) (not u_4_5) (not u_3_5))))
(assert (=> (= t_5 13) (and u_0_5 u_1_5 (and (= x_0_5 0) (= x_1_5 |s(1)|)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5)) (and (= u_1_6 u_3_5) (= x_1_6 x_3_5)) (and (= u_2_6 u_4_5) (= x_2_6 x_4_5))) (not u_4_6) (not u_3_6))))
(assert (=> (= t_6 13) (and u_0_6 u_1_6 (and (= x_0_6 0) (= x_1_6 |s(1)|)) (and (and (= u_0_7 u_2_6) (= x_0_7 x_2_6)) (and (= u_1_7 u_3_6) (= x_1_7 x_3_6)) (and (= u_2_7 u_4_6) (= x_2_7 x_4_6))) (not u_4_7) (not u_3_7))))
(assert (=> (= t_7 13) (and u_0_7 u_1_7 (and (= x_0_7 0) (= x_1_7 |s(1)|)) (and (and (= u_0_8 u_2_7) (= x_0_8 x_2_7)) (and (= u_1_8 u_3_7) (= x_1_8 x_3_7)) (and (= u_2_8 u_4_7) (= x_2_8 x_4_7))) (not u_4_8) (not u_3_8))))
(assert (=> (= t_8 13) (and u_0_8 u_1_8 (and (= x_0_8 0) (= x_1_8 |s(1)|)) (and (and (= u_0_9 u_2_8) (= x_0_9 x_2_8)) (and (= u_1_9 u_3_8) (= x_1_9 x_3_8)) (and (= u_2_9 u_4_8) (= x_2_9 x_4_8))) (not u_4_9) (not u_3_9))))
(assert (=> (= t_9 13) (and u_0_9 u_1_9 (and (= x_0_9 0) (= x_1_9 |s(1)|)) (and (and (= u_0_10 u_2_9) (= x_0_10 x_2_9)) (and (= u_1_10 u_3_9) (= x_1_10 x_3_9)) (and (= u_2_10 u_4_9) (= x_2_10 x_4_9))) (not u_4_10) (not u_3_10))))
...
(assert (and u_0_10 (= x_0_10 |s(2)|)))
(assert (and u_1_10 (= x_1_10 |s(3)|)))
(assert (and u_2_10 (= x_2_10 |s(4)|)))
(assert (not u_3_10))
(assert (not u_4_10))
...
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 7) (= t_0 8) (= t_0 9) (= t_0 10) (= t_0 13))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 7) (= t_1 8) (= t_1 9) (= t_1 10) (= t_1 13))))
(assert (=> (= t_3 1) (or (= t_2 1) (= t_2 7) (= t_2 8) (= t_2 9) (= t_2 10) (= t_2 13))))
(assert (=> (= t_4 1) (or (= t_3 1) (= t_3 7) (= t_3 8) (= t_3 9) (= t_3 10) (= t_3 13))))
(assert (=> (= t_5 1) (or (= t_4 1) (= t_4 7) (= t_4 8) (= t_4 9) (= t_4 10) (= t_4 13))))
(assert (=> (= t_6 1) (or (= t_5 1) (= t_5 7) (= t_5 8) (= t_5 9) (= t_5 10) (= t_5 13))))
(assert (=> (= t_7 1) (or (= t_6 1) (= t_6 7) (= t_6 8) (= t_6 9) (= t_6 10) (= t_6 13))))
(assert (=> (= t_8 1) (or (= t_7 1) (= t_7 7) (= t_7 8) (= t_7 9) (= t_7 10) (= t_7 13))))
(assert (=> (= t_9 1) (or (= t_8 1) (= t_8 7) (= t_8 8) (= t_8 9) (= t_8 10) (= t_8 13))))
...
; Mem: {'MSTORE_0': 13}
; L dict: {'MSTORE_0': 13, 'ADD_0': 11, 'KECCAK256_0': 12}
