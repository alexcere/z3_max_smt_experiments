...
(assert (not (= t_0 5)))
(assert (not (= t_1 5)))
(assert (=> (= t_2 5) (and (and true (and u_0_2 (= x_0_2 |s(1)|))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2))) (and true) (and true))))
(assert (not (= t_0 6)))
(assert (=> (= t_1 6) (and (and true (and u_0_1 (= x_0_1 13))) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1))) (and true) (and true))))
(assert (not (= t_2 6)))
; Store constraints
...
; Comm: {}
; Non-Comm: {'ISZERO_0': 5, 'SLOAD_0': 6}
; Mem: {}
; L dict: {'ISZERO_0': 5, 'SLOAD_0': 6}
