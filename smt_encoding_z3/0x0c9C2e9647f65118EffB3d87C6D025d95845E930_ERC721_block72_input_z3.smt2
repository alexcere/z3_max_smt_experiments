...
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(0)|) (= x_1_1 1461501637330902918203684832716283019655932542975)) (and (= x_0_1 1461501637330902918203684832716283019655932542975) (= x_1_1 |s(0)|))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (not u_4_2))))
(assert (=> (= t_2 11) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(0)|) (= x_1_2 1461501637330902918203684832716283019655932542975)) (and (= x_0_2 1461501637330902918203684832716283019655932542975) (= x_1_2 |s(0)|))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (not u_4_3))))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(0)|) (= x_1_3 1461501637330902918203684832716283019655932542975)) (and (= x_0_3 1461501637330902918203684832716283019655932542975) (= x_1_3 |s(0)|))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (not (= t_4 11)))
(assert (not (= t_0 13)))
(assert (not (= t_1 13)))
(assert (not (= t_2 13)))
(assert (=> (= t_3 13) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(3)|) (= x_1_3 |s(6)|)) (and (= x_0_3 |s(6)|) (= x_1_3 |s(3)|))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 13) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(3)|) (= x_1_4 |s(6)|)) (and (= x_0_4 |s(6)|) (= x_1_4 |s(3)|))) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
...
; Non-Comm: {'CALLER_0': 12}
; Mem: {}
; L dict: {'AND_0': 11, 'EQ_0': 13}
