...
(assert (not (= t_0 12)))
(assert (not (= t_1 12)))
(assert (=> (= t_2 12) (and (and true (and u_0_2 (= x_0_2 |s(4)|))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 12) (and (and true (and u_0_3 (= x_0_3 |s(4)|))) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (=> (= t_4 12) (and (and true (and u_0_4 (= x_0_4 |s(4)|))) u_0_5 (= x_0_5 |s(5)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4)) (and (= u_4_5 u_4_4) (= x_4_5 x_4_4))) (and true) (and true))))
(assert (=> (= t_5 12) (and (and true (and u_0_5 (= x_0_5 |s(4)|))) u_0_6 (= x_0_6 |s(5)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5)) (and (= u_3_6 u_3_5) (= x_3_6 x_3_5)) (and (= u_4_6 u_4_5) (= x_4_6 x_4_5))) (and true) (and true))))
(assert (=> (= t_6 12) (and (and true (and u_0_6 (= x_0_6 |s(4)|))) u_0_7 (= x_0_7 |s(5)|) (and (and (= u_1_7 u_1_6) (= x_1_7 x_1_6)) (and (= u_2_7 u_2_6) (= x_2_7 x_2_6)) (and (= u_3_7 u_3_6) (= x_3_7 x_3_6)) (and (= u_4_7 u_4_6) (= x_4_7 x_4_6))) (and true) (and true))))
(assert (=> (= t_7 12) (and (and true (and u_0_7 (= x_0_7 |s(4)|))) u_0_8 (= x_0_8 |s(5)|) (and (and (= u_1_8 u_1_7) (= x_1_8 x_1_7)) (and (= u_2_8 u_2_7) (= x_2_8 x_2_7)) (and (= u_3_8 u_3_7) (= x_3_8 x_3_7)) (and (= u_4_8 u_4_7) (= x_4_8 x_4_7))) (and true) (and true))))
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(0)|)) (and u_1_1 (= x_1_1 18446744073709551615))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (and true (not u_4_2)) (and true))))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 |s(0)|)) (and u_1_2 (= x_1_2 18446744073709551615))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (and true (not u_4_3)) (and true))))
(assert (=> (= t_3 11) (and (and true (and u_0_3 (= x_0_3 |s(0)|)) (and u_1_3 (= x_1_3 18446744073709551615))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (and true (not u_4_4)) (and true))))
(assert (=> (= t_4 11) (and (and true (and u_0_4 (= x_0_4 |s(0)|)) (and u_1_4 (= x_1_4 18446744073709551615))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (and true (not u_4_5)) (and true))))
(assert (=> (= t_5 11) (and (and true (and u_0_5 (= x_0_5 |s(0)|)) (and u_1_5 (= x_1_5 18446744073709551615))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (and true (not u_4_6)) (and true))))
(assert (=> (= t_6 11) (and (and true (and u_0_6 (= x_0_6 |s(0)|)) (and u_1_6 (= x_1_6 18446744073709551615))) u_0_7 (= x_0_7 |s(4)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (and true (not u_4_7)) (and true))))
(assert (not (= t_7 11)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 18446744073709551615)) (and (= t_1 0) (= a_1 18446744073709551615)) (and (= t_2 0) (= a_2 18446744073709551615)) (and (= t_3 0) (= a_3 18446744073709551615)) (and (= t_4 0) (= a_4 18446744073709551615)) (and (= t_5 0) (= a_5 18446744073709551615)) (and (= t_6 0) (= a_6 18446744073709551615)) (and (= t_7 0) (= a_7 18446744073709551615))))
...
; Comm: {}
; Non-Comm: {'GT_0': 11, 'ISZERO_0': 12}
; Mem: {}
; L dict: {'ISZERO_0': 12, 'GT_0': 11}
