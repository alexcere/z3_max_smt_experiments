...
(assert (not (= t_0 5)))
(assert (=> (= t_1 5) (and (and true (and u_0_1 (= x_0_1 8))) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1))) (and true) (and true))))
(assert (=> (= t_2 5) (and (and true (and u_0_2 (= x_0_2 8))) u_0_3 (= x_0_3 |s(1)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2))) (and true) (and true))))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 8)) (and (= t_1 0) (= a_1 8)) (and (= t_2 0) (= a_2 8))))
