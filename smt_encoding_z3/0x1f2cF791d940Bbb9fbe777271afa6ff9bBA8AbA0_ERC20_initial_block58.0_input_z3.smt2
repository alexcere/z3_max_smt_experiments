...
(assert (and u_0_4 (= x_0_4 0)))
(assert (and u_1_4 (= x_1_4 |s(4)|)))
(assert (and u_2_4 (= x_2_4 |s(5)|)))
(assert (and u_3_4 (= x_3_4 |s(5)|)))
...
(assert (or (= t_0 10) (= t_1 10) (= t_2 10)))
(assert (or (= t_0 9) (= t_1 9) (= t_2 9)))
