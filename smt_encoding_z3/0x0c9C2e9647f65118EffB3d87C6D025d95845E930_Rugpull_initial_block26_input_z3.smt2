...
(assert (not (= t_0 7)))
(assert (=> (= t_1 7) (and u_0_1 u_1_1 (or (and (= x_0_1 1) (= x_1_1 |s(0)|)) (and (= x_0_1 |s(0)|) (= x_1_1 1))) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1))) (not u_2_2))))
(assert (=> (= t_2 7) (and u_0_2 u_1_2 (or (and (= x_0_2 1) (= x_1_2 |s(0)|)) (and (= x_0_2 |s(0)|) (= x_1_2 1))) u_0_3 (= x_0_3 |s(1)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (not u_2_3))))
(assert (=> (= t_3 7) (and u_0_3 u_1_3 (or (and (= x_0_3 1) (= x_1_3 |s(0)|)) (and (= x_0_3 |s(0)|) (= x_1_3 1))) u_0_4 (= x_0_4 |s(1)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3))) (not u_2_4))))
(assert (=> (= t_4 7) (and u_0_4 u_1_4 (or (and (= x_0_4 1) (= x_1_4 |s(0)|)) (and (= x_0_4 |s(0)|) (= x_1_4 1))) u_0_5 (= x_0_5 |s(1)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4))) (not u_2_5))))
; Non-commutative constraints
; Store constraints
(assert (not (= t_0 8)))
(assert (=> (= t_1 8) (and u_0_1 u_1_1 (and (= x_0_1 |s(0)|) (= x_1_1 0)) (and (and (= u_0_2 u_2_1) (= x_0_2 x_2_1))) (not u_2_2) (not u_1_2))))
(assert (=> (= t_2 8) (and u_0_2 u_1_2 (and (= x_0_2 |s(0)|) (= x_1_2 0)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2))) (not u_2_3) (not u_1_3))))
(assert (=> (= t_3 8) (and u_0_3 u_1_3 (and (= x_0_3 |s(0)|) (= x_1_3 0)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 8) (and u_0_4 u_1_4 (and (= x_0_4 |s(0)|) (= x_1_4 0)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
; Initial stack constraints
(assert (and u_0_0 (= x_0_0 |s(0)|)))
(assert (not u_1_0))
(assert (not u_2_0))
; Final stack constraints
(assert (and u_0_5 (= x_0_5 |s(1)|)))
(assert (not u_1_5))
(assert (not u_2_5))
...
(assert (or (and (= t_0 0) (= a_0 1)) (and (= t_1 0) (= a_1 1)) (and (= t_2 0) (= a_2 1)) (and (= t_3 0) (= a_3 1)) (and (= t_4 0) (= a_4 1))))
; If we push or dup a value, the following instruction cannot be a pop
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 5) (= t_0 6) (= t_0 8))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 5) (= t_1 6) (= t_1 8))))
(assert (=> (= t_3 1) (or (= t_2 1) (= t_2 5) (= t_2 6) (= t_2 8))))
(assert (=> (= t_4 1) (or (= t_3 1) (= t_3 5) (= t_3 6) (= t_3 8))))
; All uninterpreted functions in the final stack are eventually used
; Constraints using l variables
(assert (and (<= 1 l_8) (< l_8 5)))
(assert (= (= t_1 8) (= l_8 1)))
(assert (= (= t_2 8) (= l_8 2)))
(assert (= (= t_3 8) (= l_8 3)))
(assert (= (= t_4 8) (= l_8 4)))
(assert (and (<= 1 l_7) (< l_7 5)))
(assert (= (= t_1 7) (= l_7 1)))
(assert (= (= t_2 7) (= l_7 2)))
(assert (= (= t_3 7) (= l_7 3)))
(assert (= (= t_4 7) (= l_7 4)))
