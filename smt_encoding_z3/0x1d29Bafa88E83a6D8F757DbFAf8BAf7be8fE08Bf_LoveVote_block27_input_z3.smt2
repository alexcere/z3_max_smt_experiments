...
(assert (not (= t_0 7)))
(assert (=> (= t_1 7) (and u_0_1 u_1_1 (or (and (= x_0_1 444328517) (= x_1_1 |s(0)|)) (and (= x_0_1 |s(0)|) (= x_1_1 444328517))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1))) (not u_2_2))))
(assert (=> (= t_2 7) (and u_0_2 u_1_2 (or (and (= x_0_2 444328517) (= x_1_2 |s(0)|)) (and (= x_0_2 |s(0)|) (= x_1_2 444328517))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (not u_2_3))))
...
(assert (or (and (= t_0 0) (= a_0 444328517)) (and (= t_1 0) (= a_1 444328517)) (and (= t_2 0) (= a_2 444328517))))
