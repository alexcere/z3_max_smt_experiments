...
(assert (not (= t_0 7)))
(assert (=> (= t_1 7) (and (and true (and u_0_1 (= x_0_1 |s(3)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1))) (and true) (and true))))
(assert (=> (= t_2 7) (and (and true (and u_0_2 (= x_0_2 |s(3)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2))) (and true) (and true))))
(assert (=> (= t_3 7) (and (and true (and u_0_3 (= x_0_3 |s(3)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3))) (and true) (and true))))
...
; Comm: {}
; Non-Comm: {'ISZERO_0': 7, 'RETURNDATASIZE_0': 8}
; Mem: {}
; L dict: {'ISZERO_0': 7}
