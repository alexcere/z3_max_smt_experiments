...
(assert (not (= t_0 11)))
(assert (not (= t_1 11)))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 |s(4)|))) u_0_3 (= x_0_3 |s(6)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 11) (and (and true (and u_0_3 (= x_0_3 |s(4)|))) u_0_4 (= x_0_4 |s(6)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (=> (= t_4 11) (and (and true (and u_0_4 (= x_0_4 |s(4)|))) u_0_5 (= x_0_5 |s(6)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4)) (and (= u_4_5 u_4_4) (= x_4_5 x_4_4))) (and true) (and true))))
...
(assert (not (= t_4 13)))
(assert (not (= t_0 12)))
(assert (=> (= t_1 12) (and (and true (and u_0_1 (= x_0_1 |s(5)|)) (and u_1_1 (= x_1_1 |s(1)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (and true (not u_4_2)) (and true))))
(assert (=> (= t_2 12) (and (and true (and u_0_2 (= x_0_2 |s(5)|)) (and u_1_2 (= x_1_2 |s(1)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (and true (not u_4_3)) (and true))))
(assert (=> (= t_3 12) (and (and true (and u_0_3 (= x_0_3 |s(5)|)) (and u_1_3 (= x_1_3 |s(1)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (and true (not u_4_4)) (and true))))
(assert (not (= t_4 12)))
; Store constraints
...
(assert (and u_1_5 (= x_1_5 96)))
(assert (and u_2_5 (= x_2_5 |s(0)|)))
(assert (and u_3_5 (= x_3_5 |s(1)|)))
(assert (not u_4_5))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 96)) (and (= t_1 0) (= a_1 96)) (and (= t_2 0) (= a_2 96)) (and (= t_3 0) (= a_3 96)) (and (= t_4 0) (= a_4 96))))
...
; Comm: {}
; Non-Comm: {'ISZERO_0': 11, 'LT_0': 12, 'SELFBALANCE_0': 13}
; Mem: {}
