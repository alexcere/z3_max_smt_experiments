...
(assert (=> (= t_0 11) (and (and true) u_0_1 (= x_0_1 |s(8)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0)) (and (= u_3_1 u_2_0) (= x_3_1 x_2_0)) (and (= u_4_1 u_3_0) (= x_4_1 x_3_0))) (and true) (and true (not u_4_0)))))
(assert (=> (= t_1 11) (and (and true) u_0_2 (= x_0_2 |s(8)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1)) (and (= u_3_2 u_2_1) (= x_3_2 x_2_1)) (and (= u_4_2 u_3_1) (= x_4_2 x_3_1))) (and true) (and true (not u_4_1)))))
(assert (=> (= t_2 11) (and (and true) u_0_3 (= x_0_3 |s(8)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2)) (and (= u_3_3 u_2_2) (= x_3_3 x_2_2)) (and (= u_4_3 u_3_2) (= x_4_3 x_3_2))) (and true) (and true (not u_4_2)))))
(assert (=> (= t_3 11) (and (and true) u_0_4 (= x_0_4 |s(8)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3)) (and (= u_3_4 u_2_3) (= x_3_4 x_2_3)) (and (= u_4_4 u_3_3) (= x_4_4 x_3_3))) (and true) (and true (not u_4_3)))))
(assert (=> (= t_4 11) (and (and true) u_0_5 (= x_0_5 |s(8)|) (and (and (= u_1_5 u_0_4) (= x_1_5 x_0_4)) (and (= u_2_5 u_1_4) (= x_2_5 x_1_4)) (and (= u_3_5 u_2_4) (= x_3_5 x_2_4)) (and (= u_4_5 u_3_4) (= x_4_5 x_3_4))) (and true) (and true (not u_4_4)))))
(assert (=> (= t_5 11) (and (and true) u_0_6 (= x_0_6 |s(8)|) (and (and (= u_1_6 u_0_5) (= x_1_6 x_0_5)) (and (= u_2_6 u_1_5) (= x_2_6 x_1_5)) (and (= u_3_6 u_2_5) (= x_3_6 x_2_5)) (and (= u_4_6 u_3_5) (= x_4_6 x_3_5))) (and true) (and true (not u_4_5)))))
(assert (=> (= t_6 11) (and (and true) u_0_7 (= x_0_7 |s(8)|) (and (and (= u_1_7 u_0_6) (= x_1_7 x_0_6)) (and (= u_2_7 u_1_6) (= x_2_7 x_1_6)) (and (= u_3_7 u_2_6) (= x_3_7 x_2_6)) (and (= u_4_7 u_3_6) (= x_4_7 x_3_6))) (and true) (and true (not u_4_6)))))
(assert (not (= t_7 11)))
(assert (not (= t_8 11)))
(assert (not (= t_0 14)))
(assert (not (= t_1 14)))
(assert (=> (= t_2 14) (and (and true (and u_0_2 (= x_0_2 |s(8)|)) (and u_1_2 (= x_1_2 |s(6)|))) u_0_3 (= x_0_3 |s(7)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (and true (not u_4_3)) (and true))))
(assert (=> (= t_3 14) (and (and true (and u_0_3 (= x_0_3 |s(8)|)) (and u_1_3 (= x_1_3 |s(6)|))) u_0_4 (= x_0_4 |s(7)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (and true (not u_4_4)) (and true))))
(assert (=> (= t_4 14) (and (and true (and u_0_4 (= x_0_4 |s(8)|)) (and u_1_4 (= x_1_4 |s(6)|))) u_0_5 (= x_0_5 |s(7)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (and true (not u_4_5)) (and true))))
(assert (=> (= t_5 14) (and (and true (and u_0_5 (= x_0_5 |s(8)|)) (and u_1_5 (= x_1_5 |s(6)|))) u_0_6 (= x_0_6 |s(7)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (and true (not u_4_6)) (and true))))
(assert (=> (= t_6 14) (and (and true (and u_0_6 (= x_0_6 |s(8)|)) (and u_1_6 (= x_1_6 |s(6)|))) u_0_7 (= x_0_7 |s(7)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (and true (not u_4_7)) (and true))))
(assert (=> (= t_7 14) (and (and true (and u_0_7 (= x_0_7 |s(8)|)) (and u_1_7 (= x_1_7 |s(6)|))) u_0_8 (= x_0_8 |s(7)|) (and (and (= u_1_8 u_2_7) (= x_1_8 x_2_7)) (and (= u_2_8 u_3_7) (= x_2_8 x_3_7)) (and (= u_3_8 u_4_7) (= x_3_8 x_4_7))) (and true (not u_4_8)) (and true))))
(assert (not (= t_8 14)))
(assert (=> (= t_0 13) (and (and true) u_0_1 (= x_0_1 |s(6)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0)) (and (= u_3_1 u_2_0) (= x_3_1 x_2_0)) (and (= u_4_1 u_3_0) (= x_4_1 x_3_0))) (and true) (and true (not u_4_0)))))
(assert (=> (= t_1 13) (and (and true) u_0_2 (= x_0_2 |s(6)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1)) (and (= u_3_2 u_2_1) (= x_3_2 x_2_1)) (and (= u_4_2 u_3_1) (= x_4_2 x_3_1))) (and true) (and true (not u_4_1)))))
(assert (=> (= t_2 13) (and (and true) u_0_3 (= x_0_3 |s(6)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2)) (and (= u_3_3 u_2_2) (= x_3_3 x_2_2)) (and (= u_4_3 u_3_2) (= x_4_3 x_3_2))) (and true) (and true (not u_4_2)))))
(assert (=> (= t_3 13) (and (and true) u_0_4 (= x_0_4 |s(6)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3)) (and (= u_3_4 u_2_3) (= x_3_4 x_2_3)) (and (= u_4_4 u_3_3) (= x_4_4 x_3_3))) (and true) (and true (not u_4_3)))))
(assert (=> (= t_4 13) (and (and true) u_0_5 (= x_0_5 |s(6)|) (and (and (= u_1_5 u_0_4) (= x_1_5 x_0_4)) (and (= u_2_5 u_1_4) (= x_2_5 x_1_4)) (and (= u_3_5 u_2_4) (= x_3_5 x_2_4)) (and (= u_4_5 u_3_4) (= x_4_5 x_3_4))) (and true) (and true (not u_4_4)))))
(assert (=> (= t_5 13) (and (and true) u_0_6 (= x_0_6 |s(6)|) (and (and (= u_1_6 u_0_5) (= x_1_6 x_0_5)) (and (= u_2_6 u_1_5) (= x_2_6 x_1_5)) (and (= u_3_6 u_2_5) (= x_3_6 x_2_5)) (and (= u_4_6 u_3_5) (= x_4_6 x_3_5))) (and true) (and true (not u_4_5)))))
(assert (=> (= t_6 13) (and (and true) u_0_7 (= x_0_7 |s(6)|) (and (and (= u_1_7 u_0_6) (= x_1_7 x_0_6)) (and (= u_2_7 u_1_6) (= x_2_7 x_1_6)) (and (= u_3_7 u_2_6) (= x_3_7 x_2_6)) (and (= u_4_7 u_3_6) (= x_4_7 x_3_6))) (and true) (and true (not u_4_6)))))
(assert (=> (= t_7 13) (and (and true) u_0_8 (= x_0_8 |s(6)|) (and (and (= u_1_8 u_0_7) (= x_1_8 x_0_7)) (and (= u_2_8 u_1_7) (= x_2_8 x_1_7)) (and (= u_3_8 u_2_7) (= x_3_8 x_2_7)) (and (= u_4_8 u_3_7) (= x_4_8 x_3_7))) (and true) (and true (not u_4_7)))))
(assert (not (= t_8 13)))
(assert (not (= t_0 12)))
(assert (=> (= t_1 12) (and (and true (and u_0_1 (= x_0_1 64))) u_0_2 (= x_0_2 |s(5)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 12) (and (and true (and u_0_2 (= x_0_2 64))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 12) (and (and true (and u_0_3 (= x_0_3 64))) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (=> (= t_4 12) (and (and true (and u_0_4 (= x_0_4 64))) u_0_5 (= x_0_5 |s(5)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4)) (and (= u_4_5 u_4_4) (= x_4_5 x_4_4))) (and true) (and true))))
(assert (=> (= t_5 12) (and (and true (and u_0_5 (= x_0_5 64))) u_0_6 (= x_0_6 |s(5)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5)) (and (= u_3_6 u_3_5) (= x_3_6 x_3_5)) (and (= u_4_6 u_4_5) (= x_4_6 x_4_5))) (and true) (and true))))
(assert (=> (= t_6 12) (and (and true (and u_0_6 (= x_0_6 64))) u_0_7 (= x_0_7 |s(5)|) (and (and (= u_1_7 u_1_6) (= x_1_7 x_1_6)) (and (= u_2_7 u_2_6) (= x_2_7 x_2_6)) (and (= u_3_7 u_3_6) (= x_3_7 x_3_6)) (and (= u_4_7 u_4_6) (= x_4_7 x_4_6))) (and true) (and true))))
(assert (=> (= t_7 12) (and (and true (and u_0_7 (= x_0_7 64))) u_0_8 (= x_0_8 |s(5)|) (and (and (= u_1_8 u_1_7) (= x_1_8 x_1_7)) (and (= u_2_8 u_2_7) (= x_2_8 x_2_7)) (and (= u_3_8 u_3_7) (= x_3_8 x_3_7)) (and (= u_4_8 u_4_7) (= x_4_8 x_4_7))) (and true) (and true))))
(assert (not (= t_8 12)))
; Store constraints
...
(assert (and u_1_9 (= x_1_9 |s(6)|)))
(assert (and u_2_9 (= x_2_9 |s(7)|)))
(assert (and u_3_9 (= x_3_9 |s(7)|)))
(assert (and u_4_9 (= x_4_9 |s(5)|)))
...
(assert (or (= t_0 11) (= t_1 11) (= t_2 11) (= t_3 11) (= t_4 11) (= t_5 11) (= t_6 11)))
(assert (or (= t_0 13) (= t_1 13) (= t_2 13) (= t_3 13) (= t_4 13) (= t_5 13) (= t_6 13) (= t_7 13)))
...
; Comm: {}
; Non-Comm: {'CODESIZE_0': 11, 'MLOAD_0': 12, 'PUSHSIZE_0': 13, 'SUB_0': 14}
; Mem: {}
; L dict: {'SUB_0': 14, 'MLOAD_0': 12}
