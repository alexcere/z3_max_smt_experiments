...
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and (and true (and u_0_1 (= x_0_1 |s(0)|)) (and u_1_1 (= x_1_1 57896044618658097711785492504343953926418782139537452191302581570759080747168))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (and true (not u_3_2)) (and true))))
(assert (=> (= t_2 9) (and (and true (and u_0_2 (= x_0_2 |s(0)|)) (and u_1_2 (= x_1_2 57896044618658097711785492504343953926418782139537452191302581570759080747168))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (and true (not u_3_3)) (and true))))
(assert (=> (= t_3 9) (and (and true (and u_0_3 (= x_0_3 |s(0)|)) (and u_1_3 (= x_1_3 57896044618658097711785492504343953926418782139537452191302581570759080747168))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (and true (not u_3_4)) (and true))))
(assert (not (= t_4 9)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 57896044618658097711785492504343953926418782139537452191302581570759080747168)) (and (= t_1 0) (= a_1 57896044618658097711785492504343953926418782139537452191302581570759080747168)) (and (= t_2 0) (= a_2 57896044618658097711785492504343953926418782139537452191302581570759080747168)) (and (= t_3 0) (= a_3 57896044618658097711785492504343953926418782139537452191302581570759080747168)) (and (= t_4 0) (= a_4 57896044618658097711785492504343953926418782139537452191302581570759080747168))))
