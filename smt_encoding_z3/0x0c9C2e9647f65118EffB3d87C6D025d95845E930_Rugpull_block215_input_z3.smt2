...
(assert (not (= t_1 7)))
(assert (not (= t_2 7)))
(assert (=> (= t_3 7) (and u_0_3 u_1_3 (or (and (= x_0_3 2) (= x_1_3 |s(3)|)) (and (= x_0_3 |s(3)|) (= x_1_3 2))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3))) (not u_2_4))))
(assert (=> (= t_4 7) (and u_0_4 u_1_4 (or (and (= x_0_4 2) (= x_1_4 |s(3)|)) (and (= x_0_4 |s(3)|) (= x_1_4 2))) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4))) (not u_2_5))))
(assert (not (= t_5 7)))
...
(assert (not (= t_2 8)))
(assert (not (= t_3 8)))
(assert (=> (= t_4 8) (and (and true (and u_0_4 (= x_0_4 |s(2)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4))) (and true) (and true))))
(assert (=> (= t_5 8) (and (and true (and u_0_5 (= x_0_5 |s(2)|))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5))) (and true) (and true))))
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and (and true (and u_0_1 (= x_0_1 14))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1))) (and true) (and true))))
(assert (=> (= t_2 9) (and (and true (and u_0_2 (= x_0_2 14))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2))) (and true) (and true))))
(assert (not (= t_3 9)))
(assert (not (= t_4 9)))
(assert (not (= t_5 9)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 14)) (and (= t_1 0) (= a_1 14)) (and (= t_2 0) (= a_2 14)) (and (= t_3 0) (= a_3 14)) (and (= t_4 0) (= a_4 14)) (and (= t_5 0) (= a_5 14))))
...
(assert (= (= t_4 8) (= l_8 4)))
(assert (= (= t_5 8) (= l_8 5)))
(assert (and (<= 1 l_9) (< l_9 3)))
(assert (= (= t_1 9) (= l_9 1)))
(assert (= (= t_2 9) (= l_9 2)))
(assert (and (<= 3 l_7) (< l_7 5)))
(assert (= (= t_3 7) (= l_7 3)))
(assert (= (= t_4 7) (= l_7 4)))
(assert (< l_7 l_8))
(assert (< l_9 l_7))
...
; Comm: {'EQ_0': 7}
; Non-Comm: {'ISZERO_0': 8, 'SLOAD_0': 9}
; Mem: {}
; L dict: {'ISZERO_0': 8, 'SLOAD_0': 9, 'EQ_0': 7}
