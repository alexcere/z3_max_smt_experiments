...
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(1)|)) (and u_1_1 (= x_1_1 1000000000000000))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (and true (not u_4_2)) (and true))))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 |s(1)|)) (and u_1_2 (= x_1_2 1000000000000000))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (and true (not u_4_3)) (and true))))
(assert (=> (= t_3 11) (and (and true (and u_0_3 (= x_0_3 |s(1)|)) (and u_1_3 (= x_1_3 1000000000000000))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (and true (not u_4_4)) (and true))))
(assert (not (= t_4 11)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 1000000000000000)) (and (= t_1 0) (= a_1 1000000000000000)) (and (= t_2 0) (= a_2 1000000000000000)) (and (= t_3 0) (= a_3 1000000000000000)) (and (= t_4 0) (= a_4 1000000000000000))))
