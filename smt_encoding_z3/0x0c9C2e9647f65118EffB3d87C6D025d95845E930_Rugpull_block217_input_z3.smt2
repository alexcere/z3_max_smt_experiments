...
(assert (not (= t_0 11)))
(assert (not (= t_1 11)))
(assert (=> (= t_2 11) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(1)|) (= x_1_2 |s(4)|)) (and (= x_0_2 |s(4)|) (= x_1_2 |s(1)|))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (not u_4_3))))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(1)|) (= x_1_3 |s(4)|)) (and (= x_0_3 |s(4)|) (= x_1_3 |s(1)|))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (not (= t_4 11)))
...
(assert (not (= t_0 13)))
(assert (=> (= t_1 13) (and (and true (and u_0_1 (= x_0_1 13))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (not (= t_2 13)))
(assert (not (= t_3 13)))
(assert (not (= t_4 13)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 13)) (and (= t_1 0) (= a_1 13)) (and (= t_2 0) (= a_2 13)) (and (= t_3 0) (= a_3 13)) (and (= t_4 0) (= a_4 13))))
...
(assert (and (<= 3 l_12) (< l_12 5)))
(assert (= (= t_3 12) (= l_12 3)))
(assert (= (= t_4 12) (= l_12 4)))
(assert (and (<= 1 l_13) (< l_13 2)))
(assert (= (= t_1 13) (= l_13 1)))
(assert (and (<= 2 l_11) (< l_11 4)))
...
; Comm: {'EQ_0': 11}
; Non-Comm: {'ISZERO_0': 12, 'SLOAD_0': 13}
; Mem: {}
; L dict: {'ISZERO_0': 12, 'SLOAD_0': 13, 'EQ_0': 11}
