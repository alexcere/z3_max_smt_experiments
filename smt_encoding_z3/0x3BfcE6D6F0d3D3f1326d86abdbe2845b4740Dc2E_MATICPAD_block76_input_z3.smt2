...
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (or (and (= x_0_1 1461501637330902918203684832716283019655932542975) (= x_1_1 |s(0)|)) (and (= x_0_1 |s(0)|) (= x_1_1 1461501637330902918203684832716283019655932542975))) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (not u_3_2))))
...
(assert (or (and (= t_0 0) (= a_0 1461501637330902918203684832716283019655932542975)) (and (= t_1 0) (= a_1 1461501637330902918203684832716283019655932542975))))
