...
(assert (not (= t_3 8)))
(assert (not (= t_4 8)))
(assert (=> (= t_5 8) (and u_0_5 u_1_5 (or (and (= x_0_5 1901074598) (= x_1_5 |s(3)|)) (and (= x_0_5 |s(3)|) (= x_1_5 1901074598))) u_0_6 (= x_0_6 |s(2)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5))) (not u_2_6))))
(assert (=> (= t_6 8) (and u_0_6 u_1_6 (or (and (= x_0_6 1901074598) (= x_1_6 |s(3)|)) (and (= x_0_6 |s(3)|) (= x_1_6 1901074598))) u_0_7 (= x_0_7 |s(2)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6))) (not u_2_7))))
...
(assert (or (and (= t_0 0) (= a_0 1901074598)) (and (= t_1 0) (= a_1 1901074598)) (and (= t_2 0) (= a_2 1901074598)) (and (= t_3 0) (= a_3 1901074598)) (and (= t_4 0) (= a_4 1901074598)) (and (= t_5 0) (= a_5 1901074598)) (and (= t_6 0) (= a_6 1901074598))))
...
; Comm: {'EQ_0': 8}
; Non-Comm: {'CALLDATALOAD_0': 7, 'SHR_0': 9}
; Mem: {}
; L dict: {'CALLDATALOAD_0': 7, 'SHR_0': 9, 'EQ_0': 8}
