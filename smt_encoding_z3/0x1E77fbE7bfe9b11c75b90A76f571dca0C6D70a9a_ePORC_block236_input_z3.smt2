...
(assert (=> (= t_4 8) (and (and true (and u_0_4 (= x_0_4 6))) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4))) (and true) (and true))))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 6)) (and (= t_1 0) (= a_1 6)) (and (= t_2 0) (= a_2 6)) (and (= t_3 0) (= a_3 6)) (and (= t_4 0) (= a_4 6))))
