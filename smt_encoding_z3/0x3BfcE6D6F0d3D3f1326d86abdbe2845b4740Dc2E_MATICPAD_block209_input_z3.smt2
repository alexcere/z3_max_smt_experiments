...
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (or (and (= x_0_1 1) (= x_1_1 |s(1)|)) (and (= x_0_1 |s(1)|) (= x_1_1 1))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (not u_3_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 1) (= x_1_2 |s(1)|)) (and (= x_0_2 |s(1)|) (= x_1_2 1))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
(assert (not (= t_3 9)))
...
(assert (or (and (= t_0 0) (= a_0 1)) (and (= t_1 0) (= a_1 1)) (and (= t_2 0) (= a_2 1)) (and (= t_3 0) (= a_3 1))))
