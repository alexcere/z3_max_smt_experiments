...
(assert (not (= t_0 9)))
(assert (not (= t_1 9)))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(4)|) (= x_1_2 255)) (and (= x_0_2 255) (= x_1_2 |s(4)|))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(4)|) (= x_1_3 255)) (and (= x_0_3 255) (= x_1_3 |s(4)|))) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (not u_3_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(4)|) (= x_1_4 255)) (and (= x_0_4 255) (= x_1_4 |s(4)|))) u_0_5 (= x_0_5 |s(5)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
(assert (not (= t_5 9)))
(assert (not (= t_6 9)))
(assert (not (= t_0 11)))
(assert (not (= t_1 11)))
(assert (not (= t_2 11)))
(assert (not (= t_3 11)))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(4)|) (= x_1_4 |s(5)|)) (and (= x_0_4 |s(5)|) (= x_1_4 |s(4)|))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
(assert (=> (= t_5 11) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(4)|) (= x_1_5 |s(5)|)) (and (= x_0_5 |s(5)|) (= x_1_5 |s(4)|))) u_0_6 (= x_0_6 |s(3)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5))) (not u_3_6))))
(assert (=> (= t_6 11) (and u_0_6 u_1_6 (or (and (= x_0_6 |s(4)|) (= x_1_6 |s(5)|)) (and (= x_0_6 |s(5)|) (= x_1_6 |s(4)|))) u_0_7 (= x_0_7 |s(3)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6))) (not u_3_7))))
; Non-commutative constraints
(assert (=> (= t_0 10) (and (and true (and u_0_0 (= x_0_0 |s(0)|))) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0)) (and (= u_2_1 u_2_0) (= x_2_1 x_2_0)) (and (= u_3_1 u_3_0) (= x_3_1 x_3_0))) (and true) (and true))))
(assert (=> (= t_1 10) (and (and true (and u_0_1 (= x_0_1 |s(0)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (=> (= t_2 10) (and (and true (and u_0_2 (= x_0_2 |s(0)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2))) (and true) (and true))))
(assert (=> (= t_3 10) (and (and true (and u_0_3 (= x_0_3 |s(0)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3))) (and true) (and true))))
(assert (=> (= t_4 10) (and (and true (and u_0_4 (= x_0_4 |s(0)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4))) (and true) (and true))))
(assert (=> (= t_5 10) (and (and true (and u_0_5 (= x_0_5 |s(0)|))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5)) (and (= u_3_6 u_3_5) (= x_3_6 x_3_5))) (and true) (and true))))
(assert (not (= t_6 10)))
; Store constraints
...
; Comm: {'AND_0': 9, 'EQ_0': 11}
; Non-Comm: {'CALLDATALOAD_0': 10}
; Mem: {}
; L dict: {'AND_0': 9, 'CALLDATALOAD_0': 10, 'EQ_0': 11}
