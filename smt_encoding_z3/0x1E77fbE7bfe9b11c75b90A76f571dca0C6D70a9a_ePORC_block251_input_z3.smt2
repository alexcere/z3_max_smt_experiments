...
; Store constraints
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (and (= x_0_1 7) (= x_1_1 |s(0)|)) (and (and (= u_0_2 u_2_1) (= x_0_2 x_2_1)) (and (= u_1_2 u_3_1) (= x_1_2 x_3_1))) (not u_3_2) (not u_2_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (and (= x_0_2 7) (= x_1_2 |s(0)|)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2)) (and (= u_1_3 u_3_2) (= x_1_3 x_3_2))) (not u_3_3) (not u_2_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (and (= x_0_3 7) (= x_1_3 |s(0)|)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3)) (and (= u_1_4 u_3_3) (= x_1_4 x_3_3))) (not u_3_4) (not u_2_4))))
...
(assert (or (and (= t_0 0) (= a_0 7)) (and (= t_1 0) (= a_1 7)) (and (= t_2 0) (= a_2 7)) (and (= t_3 0) (= a_3 7))))
