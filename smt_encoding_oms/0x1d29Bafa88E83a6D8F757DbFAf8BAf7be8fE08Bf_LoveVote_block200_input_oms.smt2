...
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (or (and (= x_0_1 |s(0)|) (= x_1_1 2)) (and (= x_0_1 2) (= x_1_1 |s(0)|))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (not u_3_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(0)|) (= x_1_2 2)) (and (= x_0_2 2) (= x_1_2 |s(0)|))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(0)|) (= x_1_3 2)) (and (= x_0_3 2) (= x_1_3 |s(0)|))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (not u_3_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(0)|) (= x_1_4 2)) (and (= x_0_4 2) (= x_1_4 |s(0)|))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
(assert (not (= t_5 9)))
; Non-commutative constraints
(assert (=> (= t_0 10) (and (and true) u_0_1 (= x_0_1 |s(5)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0)) (and (= u_3_1 u_2_0) (= x_3_1 x_2_0))) (and true) (and true (not u_3_0)))))
(assert (=> (= t_1 10) (and (and true) u_0_2 (= x_0_2 |s(5)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1)) (and (= u_3_2 u_2_1) (= x_3_2 x_2_1))) (and true) (and true (not u_3_1)))))
(assert (=> (= t_2 10) (and (and true) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2)) (and (= u_3_3 u_2_2) (= x_3_3 x_2_2))) (and true) (and true (not u_3_2)))))
(assert (=> (= t_3 10) (and (and true) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3)) (and (= u_3_4 u_2_3) (= x_3_4 x_2_3))) (and true) (and true (not u_3_3)))))
(assert (=> (= t_4 10) (and (and true) u_0_5 (= x_0_5 |s(5)|) (and (and (= u_1_5 u_0_4) (= x_1_5 x_0_4)) (and (= u_2_5 u_1_4) (= x_2_5 x_1_4)) (and (= u_3_5 u_2_4) (= x_3_5 x_2_4))) (and true) (and true (not u_3_4)))))
(assert (not (= t_5 10)))
(assert (not (= t_0 11)))
(assert (not (= t_1 11)))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 |s(3)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2))) (and true) (and true))))
(assert (=> (= t_3 11) (and (and true (and u_0_3 (= x_0_3 |s(3)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3))) (and true) (and true))))
(assert (=> (= t_4 11) (and (and true (and u_0_4 (= x_0_4 |s(3)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4))) (and true) (and true))))
(assert (=> (= t_5 11) (and (and true (and u_0_5 (= x_0_5 |s(3)|))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5)) (and (= u_3_6 u_3_5) (= x_3_6 x_3_5))) (and true) (and true))))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 2)) (and (= t_1 0) (= a_1 2)) (and (= t_2 0) (= a_2 2)) (and (= t_3 0) (= a_3 2)) (and (= t_4 0) (= a_4 2)) (and (= t_5 0) (= a_5 2))))
...
(assert (or (= t_0 10) (= t_1 10) (= t_2 10) (= t_3 10) (= t_4 10)))
; Constraints using l variables
(assert (and (<= 2 l_11) (< l_11 6)))
