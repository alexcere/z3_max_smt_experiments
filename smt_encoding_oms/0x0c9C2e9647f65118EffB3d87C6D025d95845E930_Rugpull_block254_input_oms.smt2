...
(assert (not (= t_0 8)))
(assert (not (= t_1 8)))
(assert (=> (= t_2 8) (and (and true (and u_0_2 (= x_0_2 |s(2)|))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2))) (and true) (and true))))
(assert (=> (= t_3 8) (and (and true (and u_0_3 (= x_0_3 |s(2)|))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3))) (and true) (and true))))
(assert (not (= t_0 7)))
(assert (=> (= t_1 7) (and (and true (and u_0_1 (= x_0_1 |s(0)|)) (and u_1_1 (= x_1_1 50))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1))) (and true (not u_2_2)) (and true))))
(assert (=> (= t_2 7) (and (and true (and u_0_2 (= x_0_2 |s(0)|)) (and u_1_2 (= x_1_2 50))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (and true (not u_2_3)) (and true))))
(assert (not (= t_3 7)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 50)) (and (= t_1 0) (= a_1 50)) (and (= t_2 0) (= a_2 50)) (and (= t_3 0) (= a_3 50))))
...
; Comm: {}
; Non-Comm: {'GT_0': 7, 'ISZERO_0': 8}
; Mem: {}
; L dict: {'ISZERO_0': 8, 'GT_0': 7}
