...
(assert (not (= t_0 9)))
(assert (not (= t_1 9)))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 255) (= x_1_2 |s(3)|)) (and (= x_0_2 |s(3)|) (= x_1_2 255))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
...
(assert (not (= t_1 10)))
(assert (not (= t_2 10)))
(assert (=> (= t_3 10) (and (and true (and u_0_3 (= x_0_3 |s(2)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3))) (and true) (and true))))
...
(assert (=> (= t_0 11) (and (and true (and u_0_0 (= x_0_0 |s(0)|))) u_0_1 (= x_0_1 |s(3)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0)) (and (= u_2_1 u_2_0) (= x_2_1 x_2_0)) (and (= u_3_1 u_3_0) (= x_3_1 x_3_0))) (and true) (and true))))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(0)|))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (not (= t_2 11)))
(assert (not (= t_3 11)))
(assert (not (= t_4 11)))
; Store constraints
...
; Comm: {'AND_0': 9}
; Non-Comm: {'ISZERO_0': 10, 'SLOAD_0': 11}
; Mem: {}
; L dict: {'ISZERO_0': 10, 'SLOAD_0': 11, 'AND_0': 9}
