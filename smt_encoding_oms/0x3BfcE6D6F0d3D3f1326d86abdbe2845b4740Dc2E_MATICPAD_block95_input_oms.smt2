...
(assert (not (= t_1 11)))
(assert (not (= t_2 11)))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 1461501637330902918203684832716283019655932542975) (= x_1_3 |s(9)|)) (and (= x_0_3 |s(9)|) (= x_1_3 1461501637330902918203684832716283019655932542975))) u_0_4 (= x_0_4 |s(6)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 1461501637330902918203684832716283019655932542975) (= x_1_4 |s(9)|)) (and (= x_0_4 |s(9)|) (= x_1_4 1461501637330902918203684832716283019655932542975))) u_0_5 (= x_0_5 |s(6)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (not (= t_5 11)))
(assert (not (= t_6 11)))
(assert (not (= t_0 13)))
(assert (not (= t_1 13)))
...
(assert (not (= t_3 13)))
(assert (not (= t_4 13)))
(assert (=> (= t_5 13) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(2)|) (= x_1_5 |s(6)|)) (and (= x_0_5 |s(6)|) (= x_1_5 |s(2)|))) u_0_6 (= x_0_6 |s(1)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (not u_4_6))))
(assert (=> (= t_6 13) (and u_0_6 u_1_6 (or (and (= x_0_6 |s(2)|) (= x_1_6 |s(6)|)) (and (= x_0_6 |s(6)|) (= x_1_6 |s(2)|))) u_0_7 (= x_0_7 |s(1)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (not u_4_7))))
; Non-commutative constraints
(assert (not (= t_0 14)))
(assert (=> (= t_1 14) (and (and true (and u_0_1 (= x_0_1 3))) u_0_2 (= x_0_2 |s(9)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 14) (and (and true (and u_0_2 (= x_0_2 3))) u_0_3 (= x_0_3 |s(9)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (not (= t_3 14)))
(assert (not (= t_4 14)))
(assert (not (= t_5 14)))
(assert (not (= t_6 14)))
...
(assert (or (and (= t_0 0) (= a_0 3)) (and (= t_1 0) (= a_1 3)) (and (= t_2 0) (= a_2 3)) (and (= t_3 0) (= a_3 3)) (and (= t_4 0) (= a_4 3)) (and (= t_5 0) (= a_5 3)) (and (= t_6 0) (= a_6 3))))
...
; Comm: {'AND_1': 11, 'EQ_0': 13}
; Non-Comm: {'CALLER_0': 12, 'SLOAD_0': 14}
; Mem: {}
; L dict: {'SLOAD_0': 14, 'AND_1': 11, 'EQ_0': 13}
