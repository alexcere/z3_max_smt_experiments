...
(assert (=> (= t_0 7) (and (and true) u_0_1 (= x_0_1 |s(1)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0))) (and true) (and true (not u_2_0)))))
(assert (=> (= t_1 7) (and (and true) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1)) (and (= u_2_2 u_1_1) (= x_2_2 x_1_1))) (and true) (and true (not u_2_1)))))
(assert (=> (= t_2 7) (and (and true) u_0_3 (= x_0_3 |s(1)|) (and (and (= u_1_3 u_0_2) (= x_1_3 x_0_2)) (and (= u_2_3 u_1_2) (= x_2_3 x_1_2))) (and true) (and true (not u_2_2)))))
(assert (=> (= t_3 7) (and (and true) u_0_4 (= x_0_4 |s(1)|) (and (and (= u_1_4 u_0_3) (= x_1_4 x_0_3)) (and (= u_2_4 u_1_3) (= x_2_4 x_1_3))) (and true) (and true (not u_2_3)))))
(assert (not (= t_4 7)))
(assert (not (= t_5 7)))
; Store constraints
(assert (not (= t_0 8)))
...
(assert (not (= t_2 8)))
(assert (not (= t_3 8)))
(assert (=> (= t_4 8) (and u_0_4 u_1_4 (and (= x_0_4 |s(0)|) (= x_1_4 115)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
(assert (=> (= t_5 8) (and u_0_5 u_1_5 (and (= x_0_5 |s(0)|) (= x_1_5 115)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5))) (not u_2_6) (not u_1_6))))
(assert (not (= t_0 9)))
(assert (not (= t_1 9)))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (and (= x_0_2 0) (= x_1_2 |s(1)|)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2))) (not u_2_3) (not u_1_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (and (= x_0_3 0) (= x_1_3 |s(1)|)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (and (= x_0_4 0) (= x_1_4 |s(1)|)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
(assert (=> (= t_5 9) (and u_0_5 u_1_5 (and (= x_0_5 0) (= x_1_5 |s(1)|)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5))) (not u_2_6) (not u_1_6))))
; Initial stack constraints
(assert (and u_0_0 (= x_0_0 |s(0)|)))
(assert (not u_1_0))
(assert (not u_2_0))
; Final stack constraints
(assert (and u_0_6 (= x_0_6 |s(0)|)))
(assert (not u_1_6))
(assert (not u_2_6))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 115)) (and (= t_1 0) (= a_1 115)) (and (= t_2 0) (= a_2 115)) (and (= t_3 0) (= a_3 115)) (and (= t_4 0) (= a_4 115)) (and (= t_5 0) (= a_5 115))))
...
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 5) (= t_0 6) (= t_0 8) (= t_0 9))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 5) (= t_1 6) (= t_1 8) (= t_1 9))))
(assert (=> (= t_3 1) (or (= t_2 1) (= t_2 5) (= t_2 6) (= t_2 8) (= t_2 9))))
(assert (=> (= t_4 1) (or (= t_3 1) (= t_3 5) (= t_3 6) (= t_3 8) (= t_3 9))))
(assert (=> (= t_5 1) (or (= t_4 1) (= t_4 5) (= t_4 6) (= t_4 8) (= t_4 9))))
; All uninterpreted functions in the final stack are eventually used
(assert (or (= t_0 7) (= t_1 7) (= t_2 7) (= t_3 7)))
; Constraints using l variables
(assert (and (<= 4 l_8) (< l_8 6)))
(assert (= (= t_4 8) (= l_8 4)))
(assert (= (= t_5 8) (= l_8 5)))
...
; Comm: {}
; Non-Comm: {'ADDRESS_0': 7}
; Mem: {'MSTORE8_0': 8, 'MSTORE_0': 9}
; L dict: {'MSTORE8_0': 8, 'MSTORE_0': 9}
