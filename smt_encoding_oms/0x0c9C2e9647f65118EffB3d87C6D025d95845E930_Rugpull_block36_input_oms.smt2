...
(assert (not (= t_0 7)))
(assert (=> (= t_1 7) (and (and true (and u_0_1 (= x_0_1 135795452)) (and u_1_1 (= x_1_1 |s(0)|))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1))) (and true (not u_2_2)) (and true))))
(assert (=> (= t_2 7) (and (and true (and u_0_2 (= x_0_2 135795452)) (and u_1_2 (= x_1_2 |s(0)|))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (and true (not u_2_3)) (and true))))
; Store constraints
