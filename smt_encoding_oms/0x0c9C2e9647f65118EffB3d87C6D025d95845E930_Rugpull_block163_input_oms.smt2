...
(assert (not (= t_1 9)))
(assert (not (= t_2 9)))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (or (and (= x_0_3 1461501637330902918203684832716283019655932542975) (= x_1_3 |s(6)|)) (and (= x_0_3 |s(6)|) (= x_1_3 1461501637330902918203684832716283019655932542975))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (not u_3_4))))
(assert (not (= t_4 9)))
(assert (not (= t_5 9)))
(assert (not (= t_0 11)))
(assert (not (= t_1 11)))
...
(assert (not (= t_3 11)))
(assert (not (= t_4 11)))
(assert (=> (= t_5 11) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(2)|) (= x_1_5 |s(3)|)) (and (= x_0_5 |s(3)|) (= x_1_5 |s(2)|))) u_0_6 (= x_0_6 |s(1)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5))) (not u_3_6))))
; Non-commutative constraints
(assert (not (= t_0 12)))
(assert (=> (= t_1 12) (and (and true (and u_0_1 (= x_0_1 10))) u_0_2 (= x_0_2 |s(6)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (not (= t_2 12)))
(assert (not (= t_3 12)))
(assert (not (= t_4 12)))
(assert (not (= t_5 12)))
...
(assert (or (and (= t_0 0) (= a_0 10)) (and (= t_1 0) (= a_1 10)) (and (= t_2 0) (= a_2 10)) (and (= t_3 0) (= a_3 10)) (and (= t_4 0) (= a_4 10)) (and (= t_5 0) (= a_5 10))))
...
(assert (and (<= 1 l_12) (< l_12 2)))
(assert (= (= t_1 12) (= l_12 1)))
(assert (and (<= 3 l_9) (< l_9 4)))
(assert (= (= t_3 9) (= l_9 3)))
(assert (and (<= 5 l_11) (< l_11 6)))
...
; Non-Comm: {'CALLER_0': 10, 'SLOAD_0': 12}
; Mem: {}
; L dict: {'SLOAD_0': 12, 'AND_0': 9, 'EQ_0': 11}
