...
(assert (=> (= t_0 11) (and u_0_0 u_1_0 (or (and (= x_0_0 |s(0)|) (= x_1_0 |s(1)|)) (and (= x_0_0 |s(1)|) (= x_1_0 |s(0)|))) u_0_1 (= x_0_1 |s(3)|) (and (and (= u_1_1 u_2_0) (= x_1_1 x_2_0)) (and (= u_2_1 u_3_0) (= x_2_1 x_3_0)) (and (= u_3_1 u_4_0) (= x_3_1 x_4_0))) (not u_4_1))))
(assert (not (= t_1 11)))
(assert (not (= t_2 11)))
; Non-commutative constraints
(assert (not (= t_0 12)))
(assert (=> (= t_1 12) (and (and true (and u_0_1 (= x_0_1 |s(3)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (not (= t_2 12)))
; Store constraints
