...
(assert (and (<= 0 t_5) (< t_5 12)))
(assert (and (<= 0 t_6) (< t_6 12)))
; Stack contraints
(assert (=> (= t_0 2) (= t_1 2)))
(assert (=> (= t_1 2) (= t_2 2)))
(assert (=> (= t_2 2) (= t_3 2)))
...
(assert (not (= t_1 9)))
(assert (not (= t_2 9)))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (or (and (= x_0_3 255) (= x_1_3 |s(3)|)) (and (= x_0_3 |s(3)|) (= x_1_3 255))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (not u_3_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (or (and (= x_0_4 255) (= x_1_4 |s(3)|)) (and (= x_0_4 |s(3)|) (= x_1_4 255))) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
(assert (=> (= t_5 9) (and u_0_5 u_1_5 (or (and (= x_0_5 255) (= x_1_5 |s(3)|)) (and (= x_0_5 |s(3)|) (= x_1_5 255))) u_0_6 (= x_0_6 |s(2)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5))) (not u_3_6))))
(assert (=> (= t_6 9) (and u_0_6 u_1_6 (or (and (= x_0_6 255) (= x_1_6 |s(3)|)) (and (= x_0_6 |s(3)|) (= x_1_6 255))) u_0_7 (= x_0_7 |s(2)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6))) (not u_3_7))))
...
(assert (not (= t_6 10)))
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 12))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 12))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2))) (and true) (and true))))
(assert (=> (= t_3 11) (and (and true (and u_0_3 (= x_0_3 12))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3))) (and true) (and true))))
(assert (=> (= t_4 11) (and (and true (and u_0_4 (= x_0_4 12))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4))) (and true) (and true))))
(assert (not (= t_5 11)))
(assert (not (= t_6 11)))
; Store constraints
...
(assert (and u_1_7 (= x_1_7 |s(4)|)))
(assert (not u_2_7))
(assert (not u_3_7))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 12)) (and (= t_1 0) (= a_1 12)) (and (= t_2 0) (= a_2 12)) (and (= t_3 0) (= a_3 12)) (and (= t_4 0) (= a_4 12)) (and (= t_5 0) (= a_5 12)) (and (= t_6 0) (= a_6 12))))
(assert (or (and (= t_0 0) (= a_0 255)) (and (= t_1 0) (= a_1 255)) (and (= t_2 0) (= a_2 255)) (and (= t_3 0) (= a_3 255)) (and (= t_4 0) (= a_4 255)) (and (= t_5 0) (= a_5 255)) (and (= t_6 0) (= a_6 255))))
...
(assert (=> (= t_6 1) (or (= t_5 1) (= t_5 6) (= t_5 7) (= t_5 8))))
; All uninterpreted functions in the final stack are eventually used
(assert (or (= t_0 10) (= t_1 10) (= t_2 10) (= t_3 10) (= t_4 10) (= t_5 10)))
...
; Comm: {'AND_0': 9}
; Non-Comm: {'PUSHTAG_0': 10, 'SLOAD_0': 11}
; Mem: {}
; L dict: {'SLOAD_0': 11, 'AND_0': 9}
