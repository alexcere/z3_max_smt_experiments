...
(assert (not (= t_0 5)))
(assert (=> (= t_1 5) (and (and true (and u_0_1 (= x_0_1 13))) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1))) (and true) (and true))))
(assert (=> (= t_2 5) (and (and true (and u_0_2 (= x_0_2 13))) u_0_3 (= x_0_3 |s(1)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2))) (and true) (and true))))
; Store constraints
; Initial stack constraints
(assert (and u_0_0 (= x_0_0 |s(0)|)))
(assert (not u_1_0))
; Final stack constraints
(assert (and u_0_3 (= x_0_3 |s(1)|)))
(assert (not u_1_3))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 13)) (and (= t_1 0) (= a_1 13)) (and (= t_2 0) (= a_2 13))))
