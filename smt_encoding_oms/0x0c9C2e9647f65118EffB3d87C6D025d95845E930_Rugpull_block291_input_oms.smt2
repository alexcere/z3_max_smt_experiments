...
(assert (not (= t_0 7)))
(assert (=> (= t_1 7) (and u_0_1 u_1_1 (or (and (= x_0_1 255) (= x_1_1 |s(0)|)) (and (= x_0_1 |s(0)|) (= x_1_1 255))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1))) (not u_2_2))))
(assert (=> (= t_2 7) (and u_0_2 u_1_2 (or (and (= x_0_2 255) (= x_1_2 |s(0)|)) (and (= x_0_2 |s(0)|) (= x_1_2 255))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (not u_2_3))))
(assert (not (= t_3 7)))
(assert (not (= t_4 7)))
...
(assert (not (= t_1 8)))
(assert (not (= t_2 8)))
(assert (=> (= t_3 8) (and u_0_3 u_1_3 (and (= x_0_3 14) (= x_1_3 |s(2)|)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 8) (and u_0_4 u_1_4 (and (= x_0_4 14) (= x_1_4 |s(2)|)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
...
(assert (or (and (= t_0 0) (= a_0 14)) (and (= t_1 0) (= a_1 14)) (and (= t_2 0) (= a_2 14)) (and (= t_3 0) (= a_3 14)) (and (= t_4 0) (= a_4 14))))
