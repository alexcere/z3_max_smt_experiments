...
(assert (not (= t_0 10)))
(assert (=> (= t_1 10) (and (and true (and u_0_1 (= x_0_1 |s(3)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
...
(assert (=> (= t_0 9) (and (and true (and u_0_0 (= x_0_0 |s(0)|)) (and u_1_0 (= x_1_0 |s(1)|))) u_0_1 (= x_0_1 |s(3)|) (and (and (= u_1_1 u_2_0) (= x_1_1 x_2_0)) (and (= u_2_1 u_3_0) (= x_2_1 x_3_0))) (and true (not u_3_1)) (and true))))
(assert (=> (= t_1 9) (and (and true (and u_0_1 (= x_0_1 |s(0)|)) (and u_1_1 (= x_1_1 |s(1)|))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (and true (not u_3_2)) (and true))))
(assert (=> (= t_2 9) (and (and true (and u_0_2 (= x_0_2 |s(0)|)) (and u_1_2 (= x_1_2 |s(1)|))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (and true (not u_3_3)) (and true))))
(assert (not (= t_3 9)))
; Store constraints
