...
(assert (not (= t_0 9)))
(assert (not (= t_1 9)))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (or (and (= x_0_2 65) (= x_1_2 |s(4)|)) (and (= x_0_2 |s(4)|) (= x_1_2 65))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2))) (not u_3_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (or (and (= x_0_3 65) (= x_1_3 |s(4)|)) (and (= x_0_3 |s(4)|) (= x_1_3 65))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3))) (not u_3_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (or (and (= x_0_4 65) (= x_1_4 |s(4)|)) (and (= x_0_4 |s(4)|) (= x_1_4 65))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4))) (not u_3_5))))
...
(assert (or (and (= t_0 0) (= a_0 65)) (and (= t_1 0) (= a_1 65)) (and (= t_2 0) (= a_2 65)) (and (= t_3 0) (= a_3 65)) (and (= t_4 0) (= a_4 65))))
