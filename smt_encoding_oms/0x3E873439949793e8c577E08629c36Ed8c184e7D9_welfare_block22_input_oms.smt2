...
(assert (not (= t_1 11)))
(assert (not (= t_2 11)))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 1461501637330902918203684832716283019655932542975) (= x_1_3 |s(5)|)) (and (= x_0_3 |s(5)|) (= x_1_3 1461501637330902918203684832716283019655932542975))) u_0_4 (= x_0_4 |s(2)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 1461501637330902918203684832716283019655932542975) (= x_1_4 |s(5)|)) (and (= x_0_4 |s(5)|) (= x_1_4 1461501637330902918203684832716283019655932542975))) u_0_5 (= x_0_5 |s(2)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (=> (= t_5 11) (and u_0_5 u_1_5 (or (and (= x_0_5 1461501637330902918203684832716283019655932542975) (= x_1_5 |s(5)|)) (and (= x_0_5 |s(5)|) (= x_1_5 1461501637330902918203684832716283019655932542975))) u_0_6 (= x_0_6 |s(2)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (not u_4_6))))
...
(assert (not (= t_5 12)))
(assert (not (= t_0 13)))
(assert (=> (= t_1 13) (and (and true (and u_0_1 (= x_0_1 1))) u_0_2 (= x_0_2 |s(5)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 13) (and (and true (and u_0_2 (= x_0_2 1))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 13) (and (and true (and u_0_3 (= x_0_3 1))) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (not (= t_4 13)))
(assert (not (= t_5 13)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 1)) (and (= t_1 0) (= a_1 1)) (and (= t_2 0) (= a_2 1)) (and (= t_3 0) (= a_3 1)) (and (= t_4 0) (= a_4 1)) (and (= t_5 0) (= a_5 1))))
...
(assert (or (= t_0 12) (= t_1 12) (= t_2 12) (= t_3 12) (= t_4 12)))
...
; Comm: {'AND_0': 11}
; Non-Comm: {'PUSHTAG_0': 12, 'SLOAD_0': 13}
; Mem: {}
; L dict: {'SLOAD_0': 13, 'AND_0': 11}
