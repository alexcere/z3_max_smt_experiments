...
(assert (=> (= t_0 5) (and (and true) u_0_1 (= x_0_1 |s(3)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0))) (and true) (and true (not u_1_0)))))
(assert (=> (= t_1 5) (and (and true) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1))) (and true) (and true (not u_1_1)))))
(assert (not (= t_2 5)))
(assert (not (= t_0 6)))
(assert (=> (= t_1 6) (and (and true (and u_0_1 (= x_0_1 1))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1))) (and true) (and true))))
(assert (=> (= t_2 6) (and (and true (and u_0_2 (= x_0_2 1))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2))) (and true) (and true))))
; Store constraints
...
(assert (and u_1_3 (= x_1_3 |s(3)|)))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 1)) (and (= t_1 0) (= a_1 1)) (and (= t_2 0) (= a_2 1))))
...
; Comm: {}
; Non-Comm: {'PUSHTAG_0': 5, 'SLOAD_0': 6}
; Mem: {}
; L dict: {'SLOAD_0': 6}
