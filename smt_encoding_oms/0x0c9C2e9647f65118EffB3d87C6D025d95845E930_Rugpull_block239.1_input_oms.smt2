...
(assert (not (= t_1 11)))
(assert (not (= t_2 11)))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 115792089237316195423570985007226406215939081747436879206741300988257197096960) (= x_1_3 |s(3)|)) (and (= x_0_3 |s(3)|) (= x_1_3 115792089237316195423570985007226406215939081747436879206741300988257197096960))) u_0_4 (= x_0_4 |s(0)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 115792089237316195423570985007226406215939081747436879206741300988257197096960) (= x_1_4 |s(3)|)) (and (= x_0_4 |s(3)|) (= x_1_4 115792089237316195423570985007226406215939081747436879206741300988257197096960))) u_0_5 (= x_0_5 |s(0)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (=> (= t_5 11) (and u_0_5 u_1_5 (or (and (= x_0_5 115792089237316195423570985007226406215939081747436879206741300988257197096960) (= x_1_5 |s(3)|)) (and (= x_0_5 |s(3)|) (= x_1_5 115792089237316195423570985007226406215939081747436879206741300988257197096960))) u_0_6 (= x_0_6 |s(0)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (not u_4_6))))
(assert (not (= t_6 11)))
(assert (not (= t_7 11)))
; Non-commutative constraints
(assert (not (= t_0 12)))
(assert (=> (= t_1 12) (and (and true (and u_0_1 (= x_0_1 10))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 12) (and (and true (and u_0_2 (= x_0_2 10))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 12) (and (and true (and u_0_3 (= x_0_3 10))) u_0_4 (= x_0_4 |s(3)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (=> (= t_4 12) (and (and true (and u_0_4 (= x_0_4 10))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4)) (and (= u_4_5 u_4_4) (= x_4_5 x_4_4))) (and true) (and true))))
(assert (=> (= t_5 12) (and (and true (and u_0_5 (= x_0_5 10))) u_0_6 (= x_0_6 |s(3)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5)) (and (= u_3_6 u_3_5) (= x_3_6 x_3_5)) (and (= u_4_6 u_4_5) (= x_4_6 x_4_5))) (and true) (and true))))
(assert (=> (= t_6 12) (and (and true (and u_0_6 (= x_0_6 10))) u_0_7 (= x_0_7 |s(3)|) (and (and (= u_1_7 u_1_6) (= x_1_7 x_1_6)) (and (= u_2_7 u_2_6) (= x_2_7 x_2_6)) (and (= u_3_7 u_3_6) (= x_3_7 x_3_6)) (and (= u_4_7 u_4_6) (= x_4_7 x_4_6))) (and true) (and true))))
(assert (not (= t_7 12)))
; Store constraints
(assert (not (= t_0 13)))
(assert (not (= t_1 13)))
...
(assert (not (= t_4 13)))
(assert (not (= t_5 13)))
(assert (=> (= t_6 13) (and u_0_6 u_1_6 (and (= x_0_6 10) (= x_1_6 |s(0)|)) (and (and (= u_0_7 u_2_6) (= x_0_7 x_2_6)) (and (= u_1_7 u_3_6) (= x_1_7 x_3_6)) (and (= u_2_7 u_4_6) (= x_2_7 x_4_6))) (not u_4_7) (not u_3_7))))
(assert (=> (= t_7 13) (and u_0_7 u_1_7 (and (= x_0_7 10) (= x_1_7 |s(0)|)) (and (and (= u_0_8 u_2_7) (= x_0_8 x_2_7)) (and (= u_1_8 u_3_7) (= x_1_8 x_3_7)) (and (= u_2_8 u_4_7) (= x_2_8 x_4_7))) (not u_4_8) (not u_3_8))))
...
(assert (and (<= 6 l_13) (< l_13 8)))
(assert (= (= t_6 13) (= l_13 6)))
(assert (= (= t_7 13) (= l_13 7)))
(assert (and (<= 1 l_12) (< l_12 7)))
...
; Non-Comm: {'SLOAD_0': 12}
; Mem: {'SSTORE_0': 13}
; L dict: {'SSTORE_0': 13, 'SLOAD_0': 12, 'AND_0': 11}
