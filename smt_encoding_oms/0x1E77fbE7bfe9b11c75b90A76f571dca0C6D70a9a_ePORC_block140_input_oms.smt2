...
(assert (=> (= t_0 10) (and (and true (and u_0_0 (= x_0_0 |s(1)|))) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0)) (and (= u_2_1 u_2_0) (= x_2_1 x_2_0)) (and (= u_3_1 u_3_0) (= x_3_1 x_3_0))) (and true) (and true))))
(assert (=> (= t_1 10) (and (and true (and u_0_1 (= x_0_1 |s(1)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1))) (and true) (and true))))
(assert (not (= t_2 10)))
(assert (not (= t_3 10)))
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and (and true (and u_0_1 (= x_0_1 |s(0)|)) (and u_1_1 (= x_1_1 |s(4)|))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (and true (not u_3_2)) (and true))))
...
; Comm: {}
; Non-Comm: {'LT_0': 9, 'SLOAD_0': 10}
; Mem: {}
; L dict: {'SLOAD_0': 10, 'LT_0': 9}
