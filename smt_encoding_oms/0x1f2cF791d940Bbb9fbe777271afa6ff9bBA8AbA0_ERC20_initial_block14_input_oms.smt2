...
; Store constraints
(assert (not (= t_0 15)))
(assert (=> (= t_1 15) (and u_0_1 u_1_1 (and (= x_0_1 |s(4)|) (= x_1_1 0)) (and (and (= u_0_2 u_2_1) (= x_0_2 x_2_1)) (and (= u_1_2 u_3_1) (= x_1_2 x_3_1)) (and (= u_2_2 u_4_1) (= x_2_2 x_4_1)) (and (= u_3_2 u_5_1) (= x_3_2 x_5_1)) (and (= u_4_2 u_6_1) (= x_4_2 x_6_1))) (not u_6_2) (not u_5_2))))
(assert (=> (= t_2 15) (and u_0_2 u_1_2 (and (= x_0_2 |s(4)|) (= x_1_2 0)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2)) (and (= u_1_3 u_3_2) (= x_1_3 x_3_2)) (and (= u_2_3 u_4_2) (= x_2_3 x_4_2)) (and (= u_3_3 u_5_2) (= x_3_3 x_5_2)) (and (= u_4_3 u_6_2) (= x_4_3 x_6_2))) (not u_6_3) (not u_5_3))))
...
(assert (and u_3_3 (= x_3_3 |s(3)|)))
(assert (and u_4_3 (= x_4_3 |s(4)|)))
(assert (not u_5_3))
(assert (not u_6_3))
...
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 9) (= t_0 10) (= t_0 11) (= t_0 12) (= t_0 13) (= t_0 14) (= t_0 15))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 9) (= t_1 10) (= t_1 11) (= t_1 12) (= t_1 13) (= t_1 14) (= t_1 15))))
