...
(assert (not (= t_0 11)))
(assert (not (= t_1 11)))
(assert (=> (= t_2 11) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(4)|) (= x_1_2 1461501637330902918203684832716283019655932542975)) (and (= x_0_2 1461501637330902918203684832716283019655932542975) (= x_1_2 |s(4)|))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (not u_4_3))))
(assert (=> (= t_3 11) (and u_0_3 u_1_3 (or (and (= x_0_3 |s(4)|) (= x_1_3 1461501637330902918203684832716283019655932542975)) (and (= x_0_3 1461501637330902918203684832716283019655932542975) (= x_1_3 |s(4)|))) u_0_4 (= x_0_4 |s(5)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3)) (and (= u_2_4 u_3_3) (= x_2_4 x_3_3)) (and (= u_3_4 u_4_3) (= x_3_4 x_4_3))) (not u_4_4))))
(assert (=> (= t_4 11) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(4)|) (= x_1_4 1461501637330902918203684832716283019655932542975)) (and (= x_0_4 1461501637330902918203684832716283019655932542975) (= x_1_4 |s(4)|))) u_0_5 (= x_0_5 |s(5)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (not (= t_5 11)))
(assert (not (= t_6 11)))
(assert (not (= t_0 13)))
(assert (not (= t_1 13)))
(assert (not (= t_2 13)))
(assert (not (= t_3 13)))
(assert (=> (= t_4 13) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(4)|) (= x_1_4 |s(5)|)) (and (= x_0_4 |s(5)|) (= x_1_4 |s(4)|))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (=> (= t_5 13) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(4)|) (= x_1_5 |s(5)|)) (and (= x_0_5 |s(5)|) (= x_1_5 |s(4)|))) u_0_6 (= x_0_6 |s(3)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (not u_4_6))))
(assert (=> (= t_6 13) (and u_0_6 u_1_6 (or (and (= x_0_6 |s(4)|) (= x_1_6 |s(5)|)) (and (= x_0_6 |s(5)|) (= x_1_6 |s(4)|))) u_0_7 (= x_0_7 |s(3)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (not u_4_7))))
...
; Comm: {'AND_0': 11, 'EQ_0': 13}
; Non-Comm: {'CALLDATALOAD_0': 12}
; Mem: {}
; L dict: {'AND_0': 11, 'CALLDATALOAD_0': 12, 'EQ_0': 13}
