...
(assert (=> (= t_0 11) (and (and true (and u_0_0 (= x_0_0 |s(2)|))) u_0_1 (= x_0_1 |s(5)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0)) (and (= u_2_1 u_2_0) (= x_2_1 x_2_0)) (and (= u_3_1 u_3_0) (= x_3_1 x_3_0)) (and (= u_4_1 u_4_0) (= x_4_1 x_4_0))) (and true) (and true))))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(2)|))) u_0_2 (= x_0_2 |s(5)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 |s(2)|))) u_0_3 (= x_0_3 |s(5)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
; Store constraints
...
(assert (and u_1_3 (= x_1_3 96)))
(assert (and u_2_3 (= x_2_3 |s(0)|)))
(assert (and u_3_3 (= x_3_3 |s(1)|)))
(assert (and u_4_3 (= x_4_3 |s(2)|)))
; All values are eventually pushed
(assert (or (and (= t_0 0) (= a_0 96)) (and (= t_1 0) (= a_1 96)) (and (= t_2 0) (= a_2 96))))
