...
(assert (not (= t_1 5)))
(assert (not (= t_2 5)))
(assert (=> (= t_3 5) (and u_0_3 u_1_3 (or (and (= x_0_3 2) (= x_1_3 |s(2)|)) (and (= x_0_3 |s(2)|) (= x_1_3 2))) u_0_4 (= x_0_4 |s(1)|) true (not u_1_4))))
; Non-commutative constraints
(assert (not (= t_0 6)))
(assert (=> (= t_1 6) (and (and true (and u_0_1 (= x_0_1 14))) u_0_2 (= x_0_2 |s(2)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1))) (and true) (and true))))
(assert (not (= t_2 6)))
(assert (not (= t_3 6)))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 14)) (and (= t_1 0) (= a_1 14)) (and (= t_2 0) (= a_2 14)) (and (= t_3 0) (= a_3 14))))
(assert (or (and (= t_0 0) (= a_0 2)) (and (= t_1 0) (= a_1 2)) (and (= t_2 0) (= a_2 2)) (and (= t_3 0) (= a_3 2))))
