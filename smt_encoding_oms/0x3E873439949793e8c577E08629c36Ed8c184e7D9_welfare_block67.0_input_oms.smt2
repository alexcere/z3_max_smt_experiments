...
(assert (= |s(6)| 115792089237316195423570985008687907853269984665640564039457584007913129639937))
...
(assert (=> (= t_0 5) (and (and true) u_0_1 (= x_0_1 |s(6)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0))) (and true) (and true (not u_1_0)))))
(assert (=> (= t_1 5) (and (and true) u_0_2 (= x_0_2 |s(6)|) (and (and (= u_1_2 u_0_1) (= x_1_2 x_0_1))) (and true) (and true (not u_1_1)))))
; Store constraints
