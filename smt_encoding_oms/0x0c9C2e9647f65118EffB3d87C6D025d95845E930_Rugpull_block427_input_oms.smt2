...
(assert (not (= t_2 12)))
(assert (not (= t_3 12)))
(assert (=> (= t_4 12) (and u_0_4 u_1_4 (or (and (= x_0_4 |s(4)|) (= x_1_4 |s(7)|)) (and (= x_0_4 |s(7)|) (= x_1_4 |s(4)|))) u_0_5 (= x_0_5 |s(3)|) (and (and (= u_1_5 u_2_4) (= x_1_5 x_2_4)) (and (= u_2_5 u_3_4) (= x_2_5 x_3_4)) (and (= u_3_5 u_4_4) (= x_3_5 x_4_4))) (not u_4_5))))
(assert (=> (= t_5 12) (and u_0_5 u_1_5 (or (and (= x_0_5 |s(4)|) (= x_1_5 |s(7)|)) (and (= x_0_5 |s(7)|) (= x_1_5 |s(4)|))) u_0_6 (= x_0_6 |s(3)|) (and (and (= u_1_6 u_2_5) (= x_1_6 x_2_5)) (and (= u_2_6 u_3_5) (= x_2_6 x_3_5)) (and (= u_3_6 u_4_5) (= x_3_6 x_4_5))) (not u_4_6))))
(assert (=> (= t_6 12) (and u_0_6 u_1_6 (or (and (= x_0_6 |s(4)|) (= x_1_6 |s(7)|)) (and (= x_0_6 |s(7)|) (= x_1_6 |s(4)|))) u_0_7 (= x_0_7 |s(3)|) (and (and (= u_1_7 u_2_6) (= x_1_7 x_2_6)) (and (= u_2_7 u_3_6) (= x_2_7 x_3_6)) (and (= u_3_7 u_4_6) (= x_3_7 x_4_6))) (not u_4_7))))
; Non-commutative constraints
(assert (not (= t_0 14)))
(assert (not (= t_1 14)))
(assert (=> (= t_2 14) (and (and true (and u_0_2 (= x_0_2 |s(6)|))) u_0_3 (= x_0_3 |s(7)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 14) (and (and true (and u_0_3 (= x_0_3 |s(6)|))) u_0_4 (= x_0_4 |s(7)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (=> (= t_4 14) (and (and true (and u_0_4 (= x_0_4 |s(6)|))) u_0_5 (= x_0_5 |s(7)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4)) (and (= u_4_5 u_4_4) (= x_4_5 x_4_4))) (and true) (and true))))
(assert (not (= t_5 14)))
(assert (not (= t_6 14)))
(assert (not (= t_0 13)))
(assert (=> (= t_1 13) (and (and true (and u_0_1 (= x_0_1 |s(4)|))) u_0_2 (= x_0_2 |s(6)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 13) (and (and true (and u_0_2 (= x_0_2 |s(4)|))) u_0_3 (= x_0_3 |s(6)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 13) (and (and true (and u_0_3 (= x_0_3 |s(4)|))) u_0_4 (= x_0_4 |s(6)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (not (= t_4 13)))
(assert (not (= t_5 13)))
(assert (not (= t_6 13)))
(assert (=> (= t_0 11) (and (and true (and u_0_0 (= x_0_0 |s(0)|))) u_0_1 (= x_0_1 |s(4)|) (and (and (= u_1_1 u_1_0) (= x_1_1 x_1_0)) (and (= u_2_1 u_2_0) (= x_2_1 x_2_0)) (and (= u_3_1 u_3_0) (= x_3_1 x_3_0)) (and (= u_4_1 u_4_0) (= x_4_1 x_4_0))) (and true) (and true))))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(0)|))) u_0_2 (= x_0_2 |s(4)|) (and (and (= u_1_2 u_1_1) (= x_1_2 x_1_1)) (and (= u_2_2 u_2_1) (= x_2_2 x_2_1)) (and (= u_3_2 u_3_1) (= x_3_2 x_3_1)) (and (= u_4_2 u_4_1) (= x_4_2 x_4_1))) (and true) (and true))))
(assert (=> (= t_2 11) (and (and true (and u_0_2 (= x_0_2 |s(0)|))) u_0_3 (= x_0_3 |s(4)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2)) (and (= u_4_3 u_4_2) (= x_4_3 x_4_2))) (and true) (and true))))
(assert (=> (= t_3 11) (and (and true (and u_0_3 (= x_0_3 |s(0)|))) u_0_4 (= x_0_4 |s(4)|) (and (and (= u_1_4 u_1_3) (= x_1_4 x_1_3)) (and (= u_2_4 u_2_3) (= x_2_4 x_2_3)) (and (= u_3_4 u_3_3) (= x_3_4 x_3_3)) (and (= u_4_4 u_4_3) (= x_4_4 x_4_3))) (and true) (and true))))
(assert (=> (= t_4 11) (and (and true (and u_0_4 (= x_0_4 |s(0)|))) u_0_5 (= x_0_5 |s(4)|) (and (and (= u_1_5 u_1_4) (= x_1_5 x_1_4)) (and (= u_2_5 u_2_4) (= x_2_5 x_2_4)) (and (= u_3_5 u_3_4) (= x_3_5 x_3_4)) (and (= u_4_5 u_4_4) (= x_4_5 x_4_4))) (and true) (and true))))
(assert (=> (= t_5 11) (and (and true (and u_0_5 (= x_0_5 |s(0)|))) u_0_6 (= x_0_6 |s(4)|) (and (and (= u_1_6 u_1_5) (= x_1_6 x_1_5)) (and (= u_2_6 u_2_5) (= x_2_6 x_2_5)) (and (= u_3_6 u_3_5) (= x_3_6 x_3_5)) (and (= u_4_6 u_4_5) (= x_4_6 x_4_5))) (and true) (and true))))
(assert (not (= t_6 11)))
; Store constraints
...
; Comm: {'EQ_0': 12}
; Non-Comm: {'CALLDATALOAD_0': 11, 'ISZERO_0': 13, 'ISZERO_1': 14}
; Mem: {}
; L dict: {'ISZERO_1': 14, 'ISZERO_0': 13, 'CALLDATALOAD_0': 11, 'EQ_0': 12}
