...
(assert (not (= t_0 8)))
(assert (not (= t_1 8)))
(assert (=> (= t_2 8) (and (and true (and u_0_2 (= x_0_2 |s(2)|)) (and u_1_2 (= x_1_2 4))) u_0_3 (= x_0_3 |s(1)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2))) (and true (not u_2_3)) (and true))))
(assert (=> (= t_3 8) (and (and true (and u_0_3 (= x_0_3 |s(2)|)) (and u_1_3 (= x_1_3 4))) u_0_4 (= x_0_4 |s(1)|) (and (and (= u_1_4 u_2_3) (= x_1_4 x_2_3))) (and true (not u_2_4)) (and true))))
; Store constraints
...
(assert (or (and (= t_0 0) (= a_0 4)) (and (= t_1 0) (= a_1 4)) (and (= t_2 0) (= a_2 4)) (and (= t_3 0) (= a_3 4))))
...
; Comm: {}
; Non-Comm: {'CALLDATASIZE_0': 7, 'LT_0': 8}
; Mem: {}
; L dict: {'LT_0': 8}
