...
; Store constraints
(assert (not (= t_0 9)))
(assert (=> (= t_1 9) (and u_0_1 u_1_1 (and (= x_0_1 13) (= x_1_1 |s(0)|)) (and (and (= u_0_2 u_2_1) (= x_0_2 x_2_1)) (and (= u_1_2 u_3_1) (= x_1_2 x_3_1))) (not u_3_2) (not u_2_2))))
(assert (=> (= t_2 9) (and u_0_2 u_1_2 (and (= x_0_2 13) (= x_1_2 |s(0)|)) (and (and (= u_0_3 u_2_2) (= x_0_3 x_2_2)) (and (= u_1_3 u_3_2) (= x_1_3 x_3_2))) (not u_3_3) (not u_2_3))))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (and (= x_0_3 13) (= x_1_3 |s(0)|)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3)) (and (= u_1_4 u_3_3) (= x_1_4 x_3_3))) (not u_3_4) (not u_2_4))))
...
(assert (or (and (= t_0 0) (= a_0 13)) (and (= t_1 0) (= a_1 13)) (and (= t_2 0) (= a_2 13)) (and (= t_3 0) (= a_3 13))))
; If we push or dup a value, the following instruction cannot be a pop
(assert (=> (= t_1 1) (or (= t_0 1) (= t_0 6) (= t_0 7) (= t_0 8) (= t_0 9))))
(assert (=> (= t_2 1) (or (= t_1 1) (= t_1 6) (= t_1 7) (= t_1 8) (= t_1 9))))
(assert (=> (= t_3 1) (or (= t_2 1) (= t_2 6) (= t_2 7) (= t_2 8) (= t_2 9))))
