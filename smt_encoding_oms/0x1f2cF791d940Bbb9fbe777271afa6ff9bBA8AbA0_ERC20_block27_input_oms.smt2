...
(assert (not (= t_1 9)))
(assert (not (= t_2 9)))
(assert (=> (= t_3 9) (and u_0_3 u_1_3 (and (= x_0_3 |s(2)|) (= x_1_3 9)) (and (and (= u_0_4 u_2_3) (= x_0_4 x_2_3))) (not u_2_4) (not u_1_4))))
(assert (=> (= t_4 9) (and u_0_4 u_1_4 (and (= x_0_4 |s(2)|) (= x_1_4 9)) (and (and (= u_0_5 u_2_4) (= x_0_5 x_2_4))) (not u_2_5) (not u_1_5))))
(assert (=> (= t_5 9) (and u_0_5 u_1_5 (and (= x_0_5 |s(2)|) (= x_1_5 9)) (and (and (= u_0_6 u_2_5) (= x_0_6 x_2_5))) (not u_2_6) (not u_1_6))))
(assert (=> (= t_6 9) (and u_0_6 u_1_6 (and (= x_0_6 |s(2)|) (= x_1_6 9)) (and (and (= u_0_7 u_2_6) (= x_0_7 x_2_6))) (not u_2_7) (not u_1_7))))
...
(assert (or (and (= t_0 0) (= a_0 9)) (and (= t_1 0) (= a_1 9)) (and (= t_2 0) (= a_2 9)) (and (= t_3 0) (= a_3 9)) (and (= t_4 0) (= a_4 9)) (and (= t_5 0) (= a_5 9)) (and (= t_6 0) (= a_6 9))))
