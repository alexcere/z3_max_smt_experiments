...
(assert (not (= t_0 6)))
(assert (not (= t_1 6)))
(assert (=> (= t_2 6) (and u_0_2 u_1_2 (and (= x_0_2 4) (= x_1_2 65)) true (not u_1_3) (not u_0_3))))
(assert (=> (= t_3 6) (and u_0_3 u_1_3 (and (= x_0_3 4) (= x_1_3 65)) true (not u_1_4) (not u_0_4))))
(assert (=> (= t_4 6) (and u_0_4 u_1_4 (and (= x_0_4 4) (= x_1_4 65)) true (not u_1_5) (not u_0_5))))
(assert (=> (= t_5 6) (and u_0_5 u_1_5 (and (= x_0_5 4) (= x_1_5 65)) true (not u_1_6) (not u_0_6))))
(assert (not (= t_0 5)))
(assert (not (= t_1 5)))
...
(assert (or (and (= t_0 0) (= a_0 65)) (and (= t_1 0) (= a_1 65)) (and (= t_2 0) (= a_2 65)) (and (= t_3 0) (= a_3 65)) (and (= t_4 0) (= a_4 65)) (and (= t_5 0) (= a_5 65))))
