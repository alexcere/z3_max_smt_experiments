...
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and u_0_1 u_1_1 (or (and (= x_0_1 1461501637330902918203684832716283019655932542975) (= x_1_1 |s(0)|)) (and (= x_0_1 |s(0)|) (= x_1_1 1461501637330902918203684832716283019655932542975))) u_0_2 (= x_0_2 |s(3)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1)) (and (= u_3_2 u_4_1) (= x_3_2 x_4_1))) (not u_4_2))))
(assert (not (= t_2 11)))
(assert (not (= t_0 12)))
(assert (not (= t_1 12)))
(assert (=> (= t_2 12) (and u_0_2 u_1_2 (or (and (= x_0_2 |s(3)|) (= x_1_2 |s(1)|)) (and (= x_0_2 |s(1)|) (= x_1_2 |s(3)|))) u_0_3 (= x_0_3 |s(2)|) (and (and (= u_1_3 u_2_2) (= x_1_3 x_2_2)) (and (= u_2_3 u_3_2) (= x_2_3 x_3_2)) (and (= u_3_3 u_4_2) (= x_3_3 x_4_2))) (not u_4_3))))
