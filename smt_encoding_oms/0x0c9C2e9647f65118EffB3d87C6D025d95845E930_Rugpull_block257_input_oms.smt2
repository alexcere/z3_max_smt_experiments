...
(assert (not (= t_0 10)))
(assert (not (= t_1 10)))
(assert (=> (= t_2 10) (and (and true (and u_0_2 (= x_0_2 |s(1)|))) u_0_3 (= x_0_3 |s(3)|) (and (and (= u_1_3 u_1_2) (= x_1_3 x_1_2)) (and (= u_2_3 u_2_2) (= x_2_3 x_2_2)) (and (= u_3_3 u_3_2) (= x_3_3 x_3_2))) (and true) (and true))))
(assert (=> (= t_0 9) (and (and true) u_0_1 (= x_0_1 |s(2)|) (and (and (= u_1_1 u_0_0) (= x_1_1 x_0_0)) (and (= u_2_1 u_1_0) (= x_2_1 x_1_0)) (and (= u_3_1 u_2_0) (= x_3_1 x_2_0))) (and true) (and true (not u_3_0)))))
(assert (not (= t_1 9)))
(assert (not (= t_2 9)))
(assert (not (= t_0 11)))
(assert (=> (= t_1 11) (and (and true (and u_0_1 (= x_0_1 |s(2)|)) (and u_1_1 (= x_1_1 |s(0)|))) u_0_2 (= x_0_2 |s(1)|) (and (and (= u_1_2 u_2_1) (= x_1_2 x_2_1)) (and (= u_2_2 u_3_1) (= x_2_2 x_3_1))) (and true (not u_3_2)) (and true))))
(assert (not (= t_2 11)))
; Store constraints
...
; Comm: {}
; Non-Comm: {'CALLVALUE_0': 9, 'ISZERO_0': 10, 'LT_0': 11}
; Mem: {}
; L dict: {'ISZERO_0': 10, 'LT_0': 11}
